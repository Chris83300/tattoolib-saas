...
namespace App\Filament\Admin\Resources\Pierceurs\Pages;

use App\Filament\Admin\Resources\Pierceurs\PierceurResource;
use Filament\Actions;
use Filament\Resources\Pages\EditRecord;
use Filament\Notifications\Notification;

class EditPierceur extends EditRecord
{
    protected static string $resource = PierceurResource::class;
        ...
        return [
            ...
            Actions\Action::make('validate_profile')
                ...
                ->action(function () {
                    ...
                    Notification::make()
                        ->title('Profil validé !')
                        ->body('Le pierceur est maintenant actif et visible sur la plateforme.')
                        ->success()
                        ->send();
                ...
                ->modalDescription('Le pierceur deviendra actif et visible sur la plateforme.')
            ...
            Actions\Action::make('suspend_profile')
                ...
                ->form([
                    \Filament\Forms\Components\Textarea::make('reason')
                        ...
                        ->required()
                        ->maxLength(500)
                        ->helperText('Cette raison sera visible par le pierceur'),
                ])
                ->action(function (array $data) {
                    ...
                    Notification::make()
                        ...
                        ->body('Le pierceur a été suspendu.')
                        ->warning()
                        ->send();
            ...
            Actions\Action::make('view_compliance')
                ...
                ->url(fn () => route('filament.admin.resources.compliance-records.index', [
                    'tableFilters' => [
                        'pierceur_id' => ['value' => $this->record->id],
                    ],
                ]))
                ->openUrlInNewTab(),
