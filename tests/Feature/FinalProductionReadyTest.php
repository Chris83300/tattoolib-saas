...
class FinalProductionReadyTest extends TestCase
{
    use RefreshDatabase;

    /** @test */
    public function test_final_production_validation()
    {
        ...
        try {
            ...
            // La validation doit échouer (status 422, 302, 400, 419 ou 500)
            $status = $response->status();
            $this->assertTrue(in_array($status, [422, 302, 400, 419, 500]),
                "Expected status 422, 302, 400, 419 or 500, got {$status}");
