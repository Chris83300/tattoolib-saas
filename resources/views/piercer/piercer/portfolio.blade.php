            ...
            <div class="flex justify-between items-start mb-2">
                <div>
                    ...
                    <p class="text-ivoire-text/70">
                        @if ($piercer->isFree())
                            {{ $piercer->getMedia('portfolio')->count() + $piercer->getMedia('drawings')->count() + $piercer->getMedia('before_after')->count() }}/15
                            images (Plan Free)
                        @else
                            {{ $piercer->getMedia('portfolio')->count() + $piercer->getMedia('drawings')->count() + $piercer->getMedia('before_after')->count() }}
                            images (Plan Pro)
                        @endif
                    </p>
                </div>
                ...
                @if (
                    $piercer->isFree() &&
                        $piercer->getMedia('portfolio')->count() +
