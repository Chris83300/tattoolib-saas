    ...
    <div class="container-custom px-4">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-gris-fonde rounded-xl p-8 mb-8 text-center">
                @if (auth()->user()->Piercer?->is_verified)
                    <div class="mb-6">
                ...
                <div class="bg-gris-fonde rounded-xl p-6">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            @else
                                <a href="{{ route('Piercer.profile') }}" class="text-beige-peau hover:underline">
            ...
            <div class="text-center mt-8">
                <a href="{{ route('Piercer.profile') }}" class="inline-block px-8 py-3 bg-beige-peau text-noir-profond font-bold rounded-lg hover:bg-beige-peau/90 transition-colors">
