    ...
    <div class="container-custom px-4">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-12">
                <!-- Formule Starter -->
                <div
                    class="bg-gris-fonde rounded-2xl btn-shadow mb-10 overflow-hidden hover:shadow-xl transition-shadow">
                    <div class="p-8">
                        <h3 class="text-2xl font-bold text-beige-peau mb-2">Starter</h3>
                        <p class="text-ivoire-text/70 mb-6">Idéal pour commencer</p>
                        <div class="mb-8">
                            <span class="text-4xl font-bold text-beige-peau">9,99€</span>
                        ...
                        <ul class="space-y-4 mb-8">
                            ...
                            <li class="flex items-center text-ivoire-text/80">
                                ...
                                <span>Réception de demandes</span>
                            </li>
                            <li class="flex items-center text-ivoire-text/80">
                                <svg class="w-5 h-5 text-beige-peau mr-3 flex-shrink-0" fill="currentColor"
                                    viewBox="0 0 20 20">
                ...
                <!-- Formule Pro -->
                <div
                    class="bg-cuivre/90 btn-shadow border border-cuivre/10 shadow-lg shadow-cuivre text-noir-profond mb-10 rounded-2xl overflow-hidden transform scale-105">
                    ...
                    <div class="p-8">
                        ...
                        <div class="mb-8 text-center">
                            <span class="text-4xl text-ivoire-text font-bold">29,99€</span>
                        ...
                        <ul class="space-y-4 mb-8 font-semibold">
                            ...
                            <li class="flex items-center">
                                ...
                                <span>Fiche client avancée</span>
                            </li>
                            <li class="flex items-center">
                                <svg class="w-5 h-5 text-vert-succes mr-3 flex-shrink-0" fill="currentColor"
                                    viewBox="0 0 20 20">
                                ...
                                <span>Export PDF fiches clients</span>
                            </li>
                            <li class="flex items-center">
                                <svg class="w-5 h-5 text-vert-succes mr-3 flex-shrink-0" fill="currentColor"
                                    viewBox="0 0 20 20">
                                ...
                                <span>Export CSV/Excel comptabilité</span>
                            </li>
                            <li class="flex items-center">
                                <svg class="w-5 h-5 text-vert-succes mr-3 flex-shrink-0" fill="currentColor"
                                    viewBox="0 0 20 20">
                ...
                <div class="bg-gris-fonde rounded-2xl btn-shadow overflow-hidden hover:shadow-xl transition-shadow">
                    <div class="p-8">
                        ...
                        <div class="mb-8 text-center">
                            <span class="text-4xl font-bold text-beige-peau">59,99€</span>
                            <span class="text-titane">/mois</span>
                            <div class="text-beige-peau text-sm mt-1">1 artiste inclus</div>
                            <div class="text-ivoire-text/80 text-sm">+ 24,99€ par artiste supplémentaire</div>
                        </div>
                        ...
                        <ul class="space-y-4 mb-8">
                            ...
                            <li class="flex items-center text-ivoire-text/80">
                                ...
                                <span class="text-ivoire-text">Support dédié</span>
                            </li>
                        </ul>
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="border-b border-titane/20">
                                ...
                                <th class="text-center py-3 px-4 text-ivoire-text">Starter</th>
                        ...
                        <tbody>
                            <tr class="border-b border-titane/10">
                                ...
                                <td class="text-center py-3 px-4 text-beige-peau font-bold">9,99€</td>
                                <td class="text-center py-3 px-4 text-beige-peau font-bold">29,99€</td>
                                <td class="text-center py-3 px-4 text-beige-peau font-bold">59,99€</td>
                            </tr>
                            <tr class="border-b border-titane/10">
