    ...
    <div class="min-h-screen bg-noir-profond">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-6">
                ...
                {{-- Bouton demande de solde — artiste, RDV completed, solde non payé --}}
                @if ($bookingRequest->status->value === 'completed'
                    && $bookingRequest->deposit_paid_at
                    && !$bookingRequest->balance_paid_at)
                    <div class="mt-4 bg-beige-peau/5 border border-beige-peau/20 rounded-xl p-4 flex items-center justify-between gap-4">
                        <div>
                            <p class="text-sm font-semibold text-beige-peau">Solde restant</p>
                        ...
                        <button x-data
                                ...
                                class="shrink-0 inline-flex items-center gap-2 px-4 py-2 bg-beige-peau text-noir-profond
                                       rounded-xl text-sm font-semibold hover:bg-beige-peau/90 transition">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                      d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                            </svg>
                            {{ $bookingRequest->isBalanceRequested() ? 'Renvoyer la demande' : 'Demander le solde' }}
                        </button>
                    </div>
                @endif
