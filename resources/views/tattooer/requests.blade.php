        ...
        <div class="space-y-4">
            @forelse($requests as $request)
                <div class="bg-gris-fonde rounded-xl p-6 hover:ring-2 hover:ring-beige-peau/50 transition-all">
                    <div class="flex flex-col md:flex-row md:items-start gap-4">
                        ...
                        <!-- Avatar client -->
                        <div
                            class="w-16 h-16 rounded-full bg-beige-peau/20 flex-shrink-0 flex items-center justify-center text-2xl">
            ...
            @empty
                <div class="bg-gris-fonde rounded-xl p-12 text-center">
                    <svg class="w-20 h-20 mx-auto mb-4 text-ivoire-text/30" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
    ...
    <div id="reject-modal" class="hidden fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4">
        <div class="bg-gris-fonde rounded-xl p-6 max-w-md w-full">
            ...
            <form id="reject-form" method="POST">
                @csrf
                <textarea name="rejection_reason" rows="4" placeholder="Raison du refus (optionnel, sera envoyée au client)..."
