        ...
        <div class="space-y-4">
                ...
                <div class="bg-gris-fonde rounded-xl p-6">
                    <div class="flex flex-col md:flex-row gap-6">
                        ...
                        <div class="flex gap-2 md:w-1/3">
                            ...
                            @empty
                                <div class="flex-1 aspect-square rounded-lg bg-noir-profond flex items-center justify-center text-ivoire-text/30">
                        ...
                        <div class="flex-1">
                            <div class="flex items-start justify-between mb-4">
                                ...
                                <span class="px-3 py-1 bg-vert-succes/20 text-vert-succes rounded-full text-sm font-semibold">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                ...
                                <div>
                                    ...
                                    <p class="font-semibold text-ivoire-text capitalize">{{ $tattoo->payment_method }}</p>
                                </div>
                                <div>
                                    <p class="text-ivoire-text/60">Photos</p>
                                    <p class="font-semibold text-ivoire-text">{{ $tattoo->getMedia('photos')->count() }}</p>
                                </div>
                                <div>
                                    <p class="text-ivoire-text/60">Traçabilité</p>
                                    @if($tattoo->project && $tattoo->project->traceability)
                                        <button onclick="showTraceability({{ $tattoo->project->traceability->id }})" 
            ...
            @empty
                <div class="bg-gris-fonde rounded-xl p-12 text-center">
                    <svg class="w-16 h-16 mx-auto mb-4 text-ivoire-text/30" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-gris-fonde rounded-xl p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <p class="font-semibold text-ivoire-text">{{ $client->consent->signed_at->format('d/m/Y à H:i') }}</p>
                    </div>
                    
                    @if($client->consent->is_minor)
                        <div>
                            <p class="text-ivoire-text/60 mb-2">Consentement parental</p>
                            <p class="font-semibold text-ivoire-text">{{ $client->consent->parent_name }} ({{ $client->consent->parent_relation }})</p>
                        </div>
                    @endif
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="bg-white p-4 rounded-lg inline-block">
                        <img src="{{ $client->consent->signature_data }}" 
                             alt="Signature"
                             class="max-w-xs">
                    </div>
                </div>
                ...
                @if($client->consent->is_minor && $client->consent->parent_signature_data)
                    <div>
                        ...
                        <div class="bg-white p-4 rounded-lg inline-block">
                            <img src="{{ $client->consent->parent_signature_data }}" 
                                 alt="Signature parent"
                                 class="max-w-xs">
                        </div>
                    </div>
                @endif
