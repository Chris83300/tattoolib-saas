...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ isset($needle['expiration_date']) ? \Carbon\Carbon::parse($needle['expiration_date'])->format('d/m/Y') : '—' }}</td>
        </tr>
        @endforeach
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ isset($ink['expiration_date']) ? \Carbon\Carbon::parse($ink['expiration_date'])->format('d/m/Y') : '—' }}</td>
