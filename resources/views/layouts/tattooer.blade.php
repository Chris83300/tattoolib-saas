    ...
    <div class="flex min-h-screen">
        ...
        <aside
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                <a href="{{ route('tattooer.dashboard') }}"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('tattooer.dashboard') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond' }} transition-colors">
                ...
                <a href="{{ route('tattooer.requests') }}"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('tattooer.requests*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond' }} transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('tattooer.calendar') }}"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('tattooer.calendar') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond' }} transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('tattooer.messages') }}"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('tattooer.messages*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond' }} transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('tattooer.payments') }}"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('tattooer.payments') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond' }} transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="pt-4 mt-4 border-t border-titane/20">
                    <a href="{{ route('tattooer.settings') }}"
                        class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('tattooer.settings') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond' }} transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="p-4 border-t border-titane/20">
                <div class="flex items-center gap-3 p-3 rounded-lg bg-noir-profond">
                    <img src="{{ auth()->user()->tattooer->getFirstMediaUrl('avatar') ?: asset('images/default-avatar.png') }}"
                        alt="Avatar" class="w-10 h-10 rounded-full">
                    <div class="flex-1 min-w-0">
                        <p class="text-ivoire-text font-semibold truncate">{{ auth()->user()->name }}</p>
                        <p class="text-ivoire-text/60 text-xs">{{ auth()->user()->tattooer->city }}</p>
                    </div>
        ...
        <nav class="lg:hidden fixed bottom-0 left-0 right-0 bg-gris-fonde border-t border-titane/20 z-50">
            <div class="grid grid-cols-5 gap-1 p-2">
                <a href="{{ route('tattooer.dashboard') }}"
                    class="flex flex-col items-center gap-1 p-2 rounded-lg {{ request()->routeIs('tattooer.dashboard') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text' }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6">
                        </path>
                ...
                <a href="{{ route('tattooer.requests') }}"
                    class="flex flex-col items-center gap-1 p-2 rounded-lg relative {{ request()->routeIs('tattooer.requests*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text' }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2">
                        </path>
                ...
                <a href="{{ route('tattooer.calendar') }}"
                    class="flex flex-col items-center gap-1 p-2 rounded-lg {{ request()->routeIs('tattooer.calendar') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text' }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z">
                        </path>
                ...
                <a href="{{ route('tattooer.messages') }}"
                    class="flex flex-col items-center gap-1 p-2 rounded-lg relative {{ request()->routeIs('tattooer.messages*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text' }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z">
                        </path>
                ...
                <button type="button" onclick="openMobileMoreMenu()"
                    class="flex flex-col items-center gap-1 p-2 rounded-lg {{ request()->routeIs('tattooer.settings') || request()->routeIs('tattooer.clients*') || request()->routeIs('tattooer.portfolio') || request()->routeIs('tattooer.payments') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text' }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z">
                        </path>
