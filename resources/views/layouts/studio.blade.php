        ...
        <aside
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('studio.requests') }}"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('studio.requests') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond' }} transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="pt-4 mt-4 border-t border-titane/20 space-y-1">
                    ...
                    <a href="{{ $studio ? route('studio.public', $studio->slug) : '#' }}"
                        class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('studio.public') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond' }} transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <nav class="lg:hidden fixed bottom-0 left-0 right-0 bg-gris-fonde border-t border-titane/20 z-50">
            <div class="grid grid-cols-5 gap-1 p-2">
                ...
                <button type="button" onclick="openStudioMoreMenu()"
                    class="flex flex-col items-center gap-1 p-2 rounded-lg {{ request()->routeIs('studio.settings') || request()->routeIs('studio.billing') || request()->routeIs('studio.stats') || request()->routeIs('studio.profile*') || request()->routeIs('studio.clients*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text' }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z">
                        </path>
