                ...
                @foreach($conversations as $conversation)
                    @php
                        ...
                        $expiryBadge = match($conversation->expiry_type) {
                            ...
                            'deposit_pending' => ['text' => '⏱️ En attente acompte', 'class' => 'bg-ambre-warning/20 text-ambre-warning'],
                            'post_appointment' => ['text' => '📋 RDV terminé', 'class' => 'bg-titane/30 text-ivoire-text/60'],
                        ...
                        <div class="flex items-start justify-between gap-4">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center gap-3 mb-2">
                                    <!-- Avatar artiste -->
                                    <div class="w-10 h-10 bg-beige-peau/20 rounded-full flex items-center justify-center flex-shrink-0">
                                        @if($artistUser?->getFirstMediaUrl('avatar'))
                                ...
                                @if($lastMessage)
                                    <div class="mt-2 bg-gris-fonde/50 rounded-lg p-2">
                                        <p class="text-sm text-ivoire-text/70 line-clamp-2">
                                            ...
                                            @else
                                                <span class="font-semibold text-ivoire-text">{{ $artistName }} :</span>
                                            @endif
                            ...
                            <div class="flex flex-col items-end gap-2 flex-shrink-0">
                                ...
                                @if($conversation->unread_count > 0)
                                    <span class="bg-rouge-alerte text-noir-profond px-2.5 py-1 rounded-full text-xs font-bold shadow-lg">
