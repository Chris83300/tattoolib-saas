    ...
    <div class="min-h-screen bg-noir-profond py-12">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-titane/20 rounded-xl border border-titane/30 p-8 mb-6">
                        ...
                        <div class="space-y-3">
                            ...
                            @if ($bookingRequest->client_payment_deadline)
                                <div class="flex justify-between">
                                    ...
                                    <span
                                        class="{{ $bookingRequest->client_payment_deadline->isPast() ? 'text-rouge-alerte' : 'text-jaune-alerte' }}">
                                        {{ $bookingRequest->client_payment_deadline->format('d/m/Y H:i') }}
                                    </span>
                                </div>
                            @endif
                        </div>
                ...
                <!-- Alertes -->
                @if ($bookingRequest->client_payment_deadline && $bookingRequest->client_payment_deadline->isPast())
                ...
                @elseif ($bookingRequest->client_payment_deadline && $bookingRequest->client_payment_deadline->diffInDays(now(), false) <= 2)
                    <?php
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-jaune-alerte text-sm">
                                    Plus que {{ $timeLeft }} pour payer l'acompte !
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-noir-profond rounded-lg p-6 mb-6">
                    ...
                    <div class="space-y-2 mb-4">
                        <div class="flex justify-between text-ivoire-text/70">
                            <span>Acompte pour réservation avec {{ $bookingRequest->bookable->user->name }}</span>
                            <span>{{ number_format($bookingRequest->total_deposit_amount, 0) }}€</span>
                        </div>
                        ...
                        <div class="border-t border-titane/30 pt-2">
                            <div class="flex justify-between text-lg font-semibold text-ivoire-text">
                                ...
                                <span
                                    class="text-beige-peau">{{ number_format($bookingRequest->total_deposit_amount, 0) }}€</span>
                            </div>
                        </div>
                    </div>
