        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
                <div class="bg-gris-fonde rounded-xl p-4 text-center">
                    <div class="text-2xl font-bold text-beige-peau mb-1">{{ $stats['total_booking-requests'] }}</div>
                    <div class="text-ivoire-text/60 text-xs">Total demandes</div>
                </div>
                <div class="bg-gris-fonde rounded-xl p-4 text-center">
                    <div class="text-2xl font-bold text-ambre-warning mb-1">{{ $stats['pending_booking-requests'] }}</div>
                    <div class="text-ivoire-text/60 text-xs">En attente</div>
                </div>
                <div class="bg-gris-fonde rounded-xl p-4 text-center">
                    <div class="text-2xl font-bold text-vert-succes mb-1">{{ $stats['accepted_booking-requests'] }}</div>
                    <div class="text-ivoire-text/60 text-xs">Acceptées</div>
                </div>
                <div class="bg-gris-fonde rounded-xl p-4 text-center">
                    <div class="text-2xl font-bold text-beige-peau mb-1">{{ $stats['in_progress_booking-requests'] }}</div>
                    <div class="text-ivoire-text/60 text-xs">En cours</div>
                </div>
                <div class="bg-gris-fonde rounded-xl p-4 text-center">
                    <div class="text-2xl font-bold text-ivoire-text/50 mb-1">{{ $stats['completed_booking-requests'] }}
                    </div>
