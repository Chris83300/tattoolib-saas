...
@section('title', 'Profil en attente de validation - Ink&Pik')
        ...
        <div class="max-w-md w-full">
            ...
            <div class="bg-gris-fonde rounded-2xl p-8 text-center">
                ...
                <div class="space-y-3">
                    ...
                    <!-- Contact support -->
                    <button
                        onclick="window.location.href='mailto:support@ink-pik.com?subject=Question validation profil - {{ $artist->user->name }}'"
