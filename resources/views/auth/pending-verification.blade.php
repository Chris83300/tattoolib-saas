...
<div class="min-h-screen bg-noir-profond flex items-center justify-center px-4 py-12">
  <div class="max-w-md w-full text-center">
    ...
    <div class="w-20 h-20 mx-auto mb-6 bg-ambre-warning/20 rounded-full flex items-center justify-center">
      <svg class="w-10 h-10 text-ambre-warning animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-gris-fonde rounded-xl p-6 mb-6">
      ...
      <p class="text-ivoire-text/70 mb-4">
        Votre compte {{ $role }} a bien été créé et est actuellement en attente de validation par notre équipe.
      </p>
      
      <div class="space-y-3 text-left">
        <div class="flex items-start gap-3">
          <svg class="w-5 h-5 text-vert-succes mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex items-start gap-3">
          <svg class="w-5 h-5 text-ambre-warning mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 15.5c-.77.833.192 2.5 1.732 2.5z"></path>
          </svg>
          <div>
            <p class="text-ivoire-text font-medium">Validation manuelle</p>
            <p class="text-ivoire-text/50 text-sm">Notre équipe vérifie vos informations professionnelles</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="space-y-3">
      ...
      <button 
        onclick="if(confirm('Êtes-vous sûr de vouloir vous déconnecter ?')) window.location.href='/logout'"
