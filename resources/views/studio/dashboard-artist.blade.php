...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-gris-fonde rounded-xl p-4 mb-6">
        <div class="flex space-x-4">
            <div class="flex-1">
                <a href="{{ route('studio.dashboard') }}" class="text-beige-peau hover:text-beige-peau/90 px-3 py-2 rounded-lg">
            ...
            <div class="flex-1">
                <a href="{{ route('studio.artists') }}" class="text-beige-peau hover:text-beige-peau/90 px-3 py-2 rounded-lg">
                    <svg class="w-5 h-5 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex-1">
                <a href="{{ route('studio.planning') }}" class="text-beige-peau hover:text-beige-peau/90 px-3 py-2 rounded-lg">
                    <svg class="w-5 h-5 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex-1">
                <a href="{{ route('studio.requests') }}" class="text-beige-peau hover:text-beige-peau/90 px-3 py-2 rounded-lg">
                    <svg class="w-5 h-5 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex-1">
                <a href="{{ route('studio.transactions') }}" class="text-beige-peau hover:text-beige-peau/90 px-3 py-2 rounded-lg">
                    <svg class="w-5 h-5 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex-1">
                <a href="{{ route('studio.stats') }}" class="text-beige-peau hover:text-beige-peau/90 px-3 py-2 rounded-lg">
                    <svg class="w-5 h-5 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex-1">
                <a href="{{ route('studio.exports') }}" class="text-beige-peau hover:text-beige-peau/90 px-3 py-2 rounded-lg">
                    <svg class="w-5 h-5 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex-1">
                <a href="{{ route('studio.settings') }}" class="text-beige-peau hover:text-beige-peau/90 px-3 py-2 rounded-lg">
                    <svg class="w-5 h-5 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
