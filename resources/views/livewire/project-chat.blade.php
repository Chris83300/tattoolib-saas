        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500">
                    Projet: {{ $project->tattoo_description }}
                </p>
            </div>
            <div class="flex items-center space-x-4">
                <span class="px-3 py-1 rounded-full text-xs font-medium
                    ...
                    {{ $project->status === 'accepted' ? 'bg-yellow-100 text-yellow-800' : '' }}
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                @if($financialInfo['deposit_amount'])
                    <div>
                        ...
                        <span class="font-semibold ml-2">{{ number_format($financialInfo['deposit_amount'], 2) }}€</span>
                ...
                @if($financialInfo['estimated_price'])
                    <div>
                        ...
                        <span class="font-semibold ml-2">{{ number_format($financialInfo['estimated_price'], 2) }}€</span>
                    </div>
                @endif
                ...
                @if($financialInfo['remaining_amount'])
                    <div>
                        ...
                        <span class="font-semibold ml-2">{{ number_format($financialInfo['remaining_amount'], 2) }}€</span>
                    </div>
                @endif
            </div>
        </div>
        ...
        @foreach($messages as $message)
            <div class="flex {{ $message['is_me'] ? 'justify-end' : 'justify-start' }}">
                <div class="max-w-lg">
                    ...
                    <div class="{{ $message['is_me'] ? 'bg-[#D4B59E] text-white' : 'bg-white text-gray-800' }} 
        ...
        <form wire:submit="sendMessage" class="space-y-4">
            ...
            <div class="flex space-x-4">
                ...
                <input type="file" wire:model="attachments" multiple 
                       accept="image/*,.pdf" class="hidden" id="file-input">
