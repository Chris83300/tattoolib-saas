...
<?php elseif($isOnTrial && $daysRemaining <= 7): ?>
...
<div class="bg-gradient-to-r from-rouge-alerte/20 to-rouge-alerte/5 border border-rouge-alerte/30 rounded-xl p-4 mb-6">
    <div class="flex items-center justify-between gap-4">
        ...
        <a href="<?php echo e($subscriptionRoute); ?>" class="flex-shrink-0 px-4 py-2 text-sm font-medium bg-beige-peau text-noir-profond rounded-lg hover:bg-beige-peau/80 transition-colors">
    ...
    <div class="flex items-center justify-between gap-4">
        <div class="flex items-center gap-3">
            ...
            <p class="text-sm text-titane">
                Essai gratuit — <strong class="text-ivoire-text"><?php echo e($daysRemaining); ?> jour<?php echo e($daysRemaining > 1 ? 's' : ''); ?> restant<?php echo e($daysRemaining > 1 ? 's' : ''); ?></strong>
            </p>
        </div>
        <a href="<?php echo e($subscriptionRoute); ?>" class="text-xs text-beige-peau hover:underline whitespace-nowrap">Activer mon abonnement</a>
    </div>
</div>
...
<div class="bg-rouge-alerte/10 border border-rouge-alerte/30 rounded-xl p-6 mb-6 text-center">
    ...
    <a href="<?php echo e($subscriptionRoute); ?>" class="inline-block mt-4 px-6 py-2.5 text-sm font-medium bg-beige-peau text-noir-profond rounded-lg hover:bg-beige-peau/80 transition-colors">
        Choisir mon abonnement
    </a>
</div>

<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\partials\trial-banner.blade.php ENDPATH**/ ?>