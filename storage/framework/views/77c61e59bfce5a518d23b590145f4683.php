<div class="container mx-auto max-w-6xl">
    ...
    <div class="mb-8">
        ...
        <a href="<?php echo e(route('tattooer.dashboard')); ?>" class="text-ivoire-text/70 hover:text-beige-peau transition-colors">
            ← Retour au dashboard
        </a>
    </div>
    ...
    <div class="bg-gris-fonde rounded-xl p-6 mb-6">
        <div class="flex flex-wrap gap-4">
            <button class="px-4 py-2 bg-beige-peau text-noir-profond rounded-lg font-semibold">
                En attente (<?php echo e($pendingRequests ?? 0); ?>)
            </button>
            <button
    ...
    <!-- Liste des demandes -->
    <div class="space-y-4">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $bookingRequests ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-gris-fonde rounded-xl p-6 hover:bg-beige-peau/5 transition-colors">
                <div class="flex justify-between items-start mb-4">
                    <div>
                        ...
                        <p class="text-ivoire-text/70 text-sm">
                            Demande du <?php echo e($request->created_at->format('d/m/Y H:i')); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <p class="text-ivoire-text"><?php echo e($request->tattoo_description ?? 'Non spécifié'); ?></p>
                    </div>
                    <div>
                        <p class="text-ivoire-text/70 text-sm mb-1">Zone du corps</p>
                        <p class="text-ivoire-text"><?php echo e($request->body_zone ?? 'Non spécifiée'); ?></p>
                    </div>
                    <div>
                        <p class="text-ivoire-text/70 text-sm mb-1">Taille</p>
                        <p class="text-ivoire-text"><?php echo e($request->tattoo_size ?? 'Non spécifiée'); ?></p>
                    </div>
                    <div>
                        <p class="text-ivoire-text/70 text-sm mb-1">Budget estimé</p>
                        <p class="text-ivoire-text">
                            <?php echo e($request->estimated_total_price ? number_format($request->estimated_total_price, 2) . '€' : 'Non spécifié'); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($request->notes): ?>
                    <div class="mb-4">
                        ...
                        <p class="text-ivoire-text"><?php echo e($request->notes); ?></p>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($request->client_selected_dates && $request->status === \App\Enums\BookingRequestStatus::DEPOSIT_PAID): ?>
                    <div class="bg-vert-succes/10 border border-vert-succes/30 rounded-xl p-4 mb-4">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $request->client_selected_dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dateInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button
                                    wire:click="openBookingModal('<?php echo e($dateInfo['date']); ?>', '<?php echo e($dateInfo['period'] ?? ''); ?>', <?php echo e($request->id); ?>)"
                                    ...
                                    <span class="text-ivoire-text font-medium">
                                        <?php echo e(\Carbon\Carbon::parse($dateInfo['date'])->translatedFormat('D d M')); ?>

                                    </span>
                                    <span class="text-xs text-titane">
                                        <?php echo e(match ($dateInfo['period'] ?? '') {'morning' => '☀️ Matin','afternoon' => '🌤️ Après-midi',default => '🔄'}); ?>
...
<?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\livewire\tattooer\booking-requests.blade.php ENDPATH**/ ?>