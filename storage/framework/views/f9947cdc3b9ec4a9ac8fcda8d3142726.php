<?php $__env->startSection('content'); ?>
    ...
    <div id="create-event-modal" class="hidden fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4">
        <div class="bg-gris-fonde rounded-xl p-6 max-w-md w-full">
            ...
            <form id="create-event-form" action="<?php echo e(route($tattooer->routePrefix() . '.calendar.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            ...
            document.getElementById('create-event-form').addEventListener('submit', function(e) {
                ...
                fetch('<?php echo e(route($tattooer->routePrefix() . '.calendar.store')); ?>', {
                        method: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                            'Content-Type': 'application/json',
