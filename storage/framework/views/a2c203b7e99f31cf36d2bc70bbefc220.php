    ...
    <div class="space-y-6">
        ...
        <div class="bg-gris-fonde rounded-xl p-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="flex flex-col sm:flex-row gap-2">
                    ...
                    <a href="<?php echo e(route('marketplace.index')); ?>" target="_blank"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-gris-fonde rounded-xl p-6 hover:ring-2 hover:ring-beige-peau transition-all cursor-pointer"
                onclick="window.location.href='<?php echo e(route('tattooer.requests')); ?>'">
                            ...
                            <div class="flex-1">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isConfirmed && $isPast): ?>
                                    <div class="mt-3 flex flex-wrap gap-2">
                                        <form action="<?php echo e(route('tattooer.appointments.complete', $appointment)); ?>"
                                            method="POST"
                                    ...
                                    <div x-data="{ open: false }"
                                        ...
                                        <div class="relative bg-white rounded-2xl p-6 max-w-md w-full shadow-xl">
                                            ...
                                            <p class="text-sm text-noir-profond/60 mb-4">Le client ne s'est pas présenté au
                                                rendez-vous ?</p>
                                            <form action="<?php echo e(route('tattooer.appointments.no-show', $appointment)); ?>"
                                                method="POST">
                                                <?php echo csrf_field(); ?>
        ...
        <!-- Upgrade PRO (si FREE) -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tattooer->subscription_plan === 'free'): ?>
            <div class="bg-gradient-to-r from-beige-peau/20 to-beige-peau/5 border-2 border-beige-peau/30 rounded-xl p-6">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="text-center">
                        ...
                        <a href="<?php echo e(route('tattooer.upgrade')); ?>"
...
<?php echo $__env->make('layouts.tattooer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tattoolib-saas\resources\views/tattooer/dashboard.blade.php ENDPATH**/ ?>