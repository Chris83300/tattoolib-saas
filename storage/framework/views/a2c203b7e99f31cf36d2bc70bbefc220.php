        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tattooer->isFree()): ?>
                    ...
                    <h3 class="text-3xl font-bold text-ivoire-text mb-1">
                        <?php echo e(number_format($monthlyEarnings['net_earnings'], 0)); ?>€
                    </h3>
                    ...
                    <div class="mt-3 p-3 bg-noir-profond/50 rounded-lg">
                        <div class="flex justify-between items-center text-xs mb-1">
                            ...
                            <span
                                class="text-ivoire-text"><?php echo e(number_format($monthlyEarnings['total_earnings'], 0)); ?>€</span>
                        </div>
                        <div class="flex justify-between items-center text-xs mb-1">
                            <span class="text-ivoire-text/70">Commission (7%):</span>
                            <span
                                class="text-rouge-alerte">-<?php echo e(number_format($monthlyEarnings['commission_amount'], 0)); ?>€</span>
                        </div>
                        <div class="flex justify-between items-center text-xs pt-1 border-t border-ivoire-text/20">
                            ...
                            <span
                                class="text-vert-succes font-bold"><?php echo e(number_format($monthlyEarnings['net_earnings'], 0)); ?>€</span>
                        </div>
                    </div>
                ...
                <?php else: ?>
                    ...
                    <h3 class="text-3xl font-bold text-ivoire-text mb-1">
                        <?php echo e(number_format($monthlyEarnings['total_earnings'], 0)); ?>€
                    </h3>
