        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="<?php echo e(route('client.booking-requests.show', $bookingRequest->id)); ?>"
                ...
                <div class="bg-[#D4B59E]/10 rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <p class="font-medium"><?php echo e($bookingRequest->bookable->user->name); ?></p>
                        </div>
                        <div>
                            <span class="text-gray-600">Description:</span>
                            <p class="font-medium"><?php echo e($bookingRequest->tattoo_description); ?></p>
                        </div>
                        <div>
                            <span class="text-gray-600">Emplacement:</span>
                            <p class="font-medium"><?php echo e($bookingRequest->tattoo_location); ?></p>
                        </div>
                        <div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex justify-between items-center py-3 border-b">
                        ...
                        <span class="font-semibold text-lg"><?php echo e(number_format($bookingRequest->estimated_price, 2)); ?>€</span>
                    </div>
                    ...
                    <div class="flex justify-between items-center py-3 border-b">
                        <div>
                            ...
                            <p class="text-xs text-gray-500">
                                <?php echo e(round(($bookingRequest->deposit_amount / $bookingRequest->estimated_price) * 100, 1)); ?>%
                                du total
                            </p>
                        </div>
                        <span
                            class="font-semibold text-lg text-[#D4B59E]"><?php echo e(number_format($bookingRequest->deposit_amount, 2)); ?>€</span>
                    </div>
                    ...
                    <div class="flex justify-between items-center py-3">
                        ...
                        <span class="font-semibold text-lg">
                            <?php echo e(number_format($bookingRequest->estimated_price - $bookingRequest->deposit_amount, 2)); ?>€
                        </span>
                    </div>
                </div>

                <!-- Images de référence -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bookingRequest->getMedia('reference_images')->count() > 0): ?>
                    <div class="mt-6">
                        <h3 class="text-sm font-medium text-gray-700 mb-2">Images de référence</h3>
                        <div class="grid grid-cols-3 gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $bookingRequest->getMedia('reference_images')->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <img src="<?php echo e($media->getUrl('thumbnail')); ?>" alt="Reference"
                                    class="w-full h-20 object-cover rounded">
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php if($bookingRequest->getMedia('reference_images')->count() > 3): ?>
                                <div
                                    class="w-full h-20 bg-gray-200 rounded flex items-center justify-center text-sm text-gray-600">
                                    +<?php echo e($bookingRequest->getMedia('reference_images')->count() - 3); ?>
    ...
    <script>
        ...
        checkoutButton.addEventListener('click', async () => {
            ...
            try {
                ...
                const response = await fetch('<?php echo e(route('deposit.process', $bookingRequest->id)); ?>', {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\deposit\payment.blade.php ENDPATH**/ ?>