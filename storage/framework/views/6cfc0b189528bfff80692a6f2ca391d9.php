...
<?php $__env->startSection('content'); ?>
    <div class="max-w-4xl mx-auto space-y-6">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tattooer->isPro()): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeSubscription?->isOnGracePeriod()): ?>
                    <div class="mt-3 bg-ambre-warning/10 border border-ambre-warning/30 rounded-lg p-3">
                        ...
                        <form action="<?php echo e(route('tattooer.subscription.resume')); ?>" method="POST" class="mt-2">
                            <?php echo csrf_field(); ?>
                            <button type="submit"
                ...
                <?php else: ?>
                    <div class="mt-3 flex flex-wrap gap-3">
                        <a href="<?php echo e(route('tattooer.subscription.manage')); ?>"
                            class="px-4 py-2 bg-titane/20 text-ivoire-text rounded-lg text-sm font-semibold hover:bg-titane/30 transition-colors">
                            💳 Gérer le paiement
                        </a>
                        <form action="<?php echo e(route('tattooer.subscription.cancel')); ?>" method="POST"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div
                class="bg-gris-fonde rounded-xl p-6 border <?php echo e($tattooer->isFree() ? 'border-titane/40' : 'border-titane/20'); ?>">
            ...
            <div class="bg-gris-fonde rounded-xl p-6 border-2 border-beige-peau relative">
                ...
                <?php if($tattooer->isPro() && !$activeSubscription?->isOnGracePeriod()): ?>
                ...
                <?php elseif(!$tattooer->isPro()): ?>
                    <form action="<?php echo e(route('tattooer.subscription.subscribe')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <button type="submit"
...
<?php echo $__env->make('layouts.tattooer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\tattooer\subscription-plans.blade.php ENDPATH**/ ?>