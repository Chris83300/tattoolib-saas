...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-gradient-to-br from-beige-peau/20 to-beige-peau/5 border-2 border-beige-peau rounded-2xl p-8 relative">
            ...
            <form action="<?php echo e(route($tattooer->routePrefix() . '.upgrade.process')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <button type="submit" 
...
<?php echo $__env->make('layouts.tattooer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\tattooer\upgrade.blade.php ENDPATH**/ ?>