<div class="fixed bottom-20 right-6 z-50">
    ...
    <div class="relative">
        ...
        <button wire:click="<?php echo e($isOpen ? 'close' : 'open'); ?>"
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isOpen): ?>
        <div class="absolute bottom-20 right-0 w-80 sm:w-96 bg-gris-fonde rounded-2xl
            ...
            <div class="flex-1 overflow-y-auto p-4 space-y-3" id="admin-chat-messages" wire:poll.3s="$refresh" x-data
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->messages->isEmpty()): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $isAdmin = ($message->sender_type ?? '') === 'admin' || $message->sender_id === null;
                        $isUser = !$isAdmin;
                    ?>

                    <div class="flex <?php echo e($isUser ? 'justify-end' : 'justify-start'); ?> gap-2">
                        ...
                        <?php echo e($isAdmin
                            ...
                            <p class="text-xs text-gray-400 mt-0.5 <?php echo e($isUser ? 'text-right' : 'text-left'); ?>">
