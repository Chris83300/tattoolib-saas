...
$__key = 'calendar-repropose-' . $bookingRequest->id;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1418354511-0', $__key);
...
?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($bookingRequest) && $bookingRequest): ?>
        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1418354511-1', $__key);
