        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-6">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($expiryInfo && $expiryInfo['warning_message']): ?>
                    <div class="mb-4 p-4 rounded-lg border <?php echo e($expiryInfo['is_expired'] ? 'bg-rouge-alerte/10 border-rouge-alerte/30' : 'bg-jaune-alerte/10 border-jaune-alerte/30'); ?>">
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                <h3 class="font-semibold <?php echo e($expiryInfo['is_expired'] ? 'text-rouge-alerte' : 'text-jaune-alerte'); ?> mb-1">
                                ...
                                <p class="<?php echo e($expiryInfo['is_expired'] ? 'text-rouge-alerte' : 'text-jaune-alerte'); ?> text-sm">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$expiryInfo['is_expired'] && $expiryInfo['time_remaining'] !== ''): ?>
                                    <div class="mt-2">
                                        <div class="flex items-center justify-between text-sm">
                                            <span class="<?php echo e($expiryInfo['days_remaining'] <= 2 ? 'text-rouge-alerte font-semibold' : 'text-jaune-alerte'); ?>">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-ivoire-text">Chat avec <?php echo e($bookingRequest->bookable->user->name); ?></h1>
                        <p class="text-ivoire-text/70 mt-1">Projet: <?php echo e(Str::limit($bookingRequest->tattoo_description, 80)); ?></p>
                    </div>
                </div>
            </div>
                    ...
                    <?php else: ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($existingConsent && $existingConsent->isValid()): ?>
                                        <div class="flex justify-center mb-4">
                                            <div class="bg-vert-succes/10 border border-vert-succes/30 rounded-xl p-4 text-center max-w-sm">
                                                ...
                                                <p class="text-xs text-titane mt-1">Le <?php echo e($existingConsent->signed_at->format('d/m/Y à H:i')); ?></p>
                                            </div>
                                        </div>
                                    <?php else: ?>
                                        <div class="flex justify-center mb-4">
                                    ...
                                    <div class="flex justify-center mb-4">
                                        <div class="max-w-sm">
                                            <div class="bg-titane/20 border border-titane/30 text-ivoire-text/80 rounded-lg px-4 py-2 text-center">
                                                ...
                                                <p class="text-xs text-ivoire-text/50 mt-1"><?php echo e($message->created_at->format('H:i')); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php else: ?>
                                ...
                                <div class="flex <?php echo e($message->sender_type === 'tattooer' ? 'justify-start' : 'justify-end'); ?> mb-4">
                                    <div class="max-w-xs lg:max-w-md">
                                        <div class="<?php echo e($message->sender_type === 'tattooer'
                                        ...
                                        <p class="text-xs text-ivoire-text/50 mt-1 <?php echo e($message->sender_type === 'tattooer' ? '' : 'text-right'); ?>">
                    ...
                    <div class="bg-vert-succes/5 border border-vert-succes/20 rounded-xl p-4 mx-4 mt-4">
                        ...
                        <div class="space-y-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $bookingRequest->proposed_dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <form action="<?php echo e(route('client.booking-request.select-date', $bookingRequest)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                        ...
                        <form action="<?php echo e(route('client.booking-request.request-alternatives', $bookingRequest)); ?>" method="POST" class="mt-2">
                            <?php echo csrf_field(); ?>
                ...
                <?php elseif($bookingRequest->confirmed_date && !$bookingRequest->appointment_datetime): ?>
                    <div class="bg-vert-succes/10 border border-vert-succes/30 rounded-lg p-4 mx-4 mt-4">
                        <p class="text-sm text-vert-succes font-medium">
                            ✅ Date choisie : <?php echo e(\Carbon\Carbon::parse($bookingRequest->confirmed_date)->translatedFormat('l d F Y')); ?>
                                ...
                                <div class="bg-jaune-alerte/10 border border-jaune-alerte/30 rounded-lg p-3 mb-4">
                                    <p class="text-jaune-alerte text-sm">
                                        ...
                                        <span class="block mt-1">
                                            Délai : <?php echo e($daysRemaining > 0 ? $daysRemaining . ' jour(s) restant(s)' : 'Dernier jour'); ?>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div class="bg-noir-profond/30 rounded-lg p-3">
                                            ...
                                            <p class="text-ivoire-text/50 text-xs mt-1">
                                                <?php echo e($summary['designs_included']); ?> inclus — <?php echo e($summary['designs_remaining']); ?> restant(s)
                                            </p>
                                        </div>
                                        ...
                                        <div class="bg-noir-profond/30 rounded-lg p-3">
                                            <div class="flex items-center justify-between mb-2">
                                                ...
                                                <span class="text-vert-succes font-bold"><?php echo e($summary['modifications_used_current']); ?></span>
                                            </div>
                                            <div class="w-full bg-titane/30 rounded-full h-2">
                                            ...
                                            <p class="text-ivoire-text/50 text-xs mt-1">
                                                <?php echo e($summary['modifications_per_design']); ?> par dessin — <?php echo e($summary['modifications_remaining_current']); ?> restante(s)
                                            </p>
                                        </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bookingRequest->status->value === 'accepted' && !$bookingRequest->deposit_paid_at): ?>
                <div class="mt-6 bg-titane/20 rounded-xl border border-titane/30 p-6">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        <form action="<?php echo e(route('client.booking-request.cancel', $bookingRequest)); ?>" method="POST" class="flex-1">
                            <?php echo csrf_field(); ?>
        ...
        <div class="flex min-h-full items-end sm:items-center justify-center p-0 sm:p-4">
            <div class="bg-gris-fonde w-full sm:max-w-2xl sm:rounded-2xl rounded-t-2xl max-h-[95vh] overflow-y-auto">
                ...
                <form action="<?php echo e(route('client.consent.store', $bookingRequest)); ?>" method="POST"
                    ...
                    id="consent-form-<?php echo e($bookingRequest->id); ?>"
                    novalidate
                    onsubmit="return prepareAndValidateConsent(<?php echo e($bookingRequest->id); ?>, <?php echo e($isMinor ? 'true' : 'false'); ?>)">
                    <?php echo csrf_field(); ?>

                    
                    <input type="hidden" name="act_type" value="<?php echo e(strtolower($bookingRequest->tattoo_type ?? 'tatouage')); ?>">
                    <input type="hidden" name="body_zone" value="<?php echo e($bookingRequest->body_zone ?? ''); ?>">
                    <input type="hidden" name="act_description" value="<?php echo e($bookingRequest->tattoo_description ?? $bookingRequest->description ?? ''); ?>">
                    <input type="hidden" name="total_price" value="<?php echo e($bookingRequest->total_price ?? $bookingRequest->estimated_total_price ?? 0); ?>">
                    <input type="hidden" name="deposit_amount" value="<?php echo e($bookingRequest->deposit_amount ?? $bookingRequest->total_deposit_amount ?? 0); ?>">
                    ...
                    <div x-show="step === 1" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <input type="email" name="client_email" required value="<?php echo e($client->user?->email ?? $client->email ?? ''); ?>"
                                    class="w-full px-3 py-2 bg-noir-profond border border-titane/30 rounded-lg text-ivoire-text text-sm focus:border-beige-peau">
                            </div>
                        </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isMinor): ?>
                            <div class="bg-ambre-warning/10 border border-ambre-warning/30 rounded-lg p-4 space-y-3">
                                ...
                                <div>
                                    <label class="text-xs text-titane block mb-1">📎 Copie pièce d'identité *</label>
                                ...
                                <div>
                                    ...
                                    <canvas class="sig-canvas w-full bg-white rounded-lg border-2 border-ambre-warning/30 cursor-crosshair"
                                        data-signature="parent-<?php echo e($bookingRequest->id); ?>" style="touch-action: none; height: 100px;"></canvas>
                                    <input type="hidden" name="parent_signature_data" class="parent-sig-data-<?php echo e($bookingRequest->id); ?>">
                                    <button type="button" onclick="clearSigCanvas(document.querySelector('[data-signature=\'parent-<?php echo e($bookingRequest->id); ?>\']'))"
                        ...
                        <div class="bg-noir-profond/50 rounded-lg p-3 space-y-1">
                            <p class="text-sm text-ivoire-text"><strong>Type :</strong> <?php echo e(ucfirst($bookingRequest->tattoo_type ?? 'Tatouage')); ?></p>
                            <p class="text-xs text-titane"><strong>Zone :</strong> <?php echo e($bookingRequest->body_zone ?? 'Non précisé'); ?> · <strong>Style :</strong> <?php echo e($bookingRequest->tattoo_style ?? 'Non précisé'); ?></p>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $medicalItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-noir-profond/30 rounded-lg p-3">
                                <label class="flex items-center gap-3 cursor-pointer">
                                    ...
                                    <span class="text-sm text-ivoire-text"><?php echo e($item['icon']); ?> <?php echo e($item['label']); ?></span>
                                </label>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['detail']): ?>
                                    <div x-show="medicalFlags.<?php echo e($key); ?>" x-collapse class="mt-2 ml-8">
                                        <input type="text" name="medical_<?php echo e($key); ?>_detail" placeholder="Précisez..."
                        ...
                        <div class="bg-noir-profond/50 rounded-lg p-3 space-y-2 text-sm text-ivoire-text">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bookingRequest->price_estimate_max ?? $bookingRequest->estimated_total_price): ?>
                                <p>💰 <strong>Prix estimé :</strong>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($bookingRequest->price_estimate_min ?? null) && ($bookingRequest->price_estimate_min != ($bookingRequest->price_estimate_max ?? null))): ?>
                                        <?php echo e(number_format($bookingRequest->price_estimate_min, 0)); ?>€ - <?php echo e(number_format($bookingRequest->price_estimate_max, 0)); ?>€
                                    <?php else: ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bookingRequest->total_deposit_amount): ?>
                                <p>🔒 <strong>Acompte versé :</strong> <?php echo e(number_format($bookingRequest->total_deposit_amount, 0)); ?>€
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bookingRequest->deposit_paid_at): ?> <span class="text-vert-succes">(payé)</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    ...
                    <div x-show="step === 4" class="space-y-4">
                        ...
                        <div>
                            ...
                            <canvas class="sig-canvas w-full bg-white rounded-lg border-2 border-beige-peau/30 cursor-crosshair"
                                data-signature="client-<?php echo e($bookingRequest->id); ?>" style="touch-action: none; height: 120px;"></canvas>
                            <input type="hidden" name="signature_data" class="client-sig-data-<?php echo e($bookingRequest->id); ?>">
                            <button type="button" onclick="clearSigCanvas(document.querySelector('[data-signature=\'client-<?php echo e($bookingRequest->id); ?>\']'))"
                ...
                <div class="bg-gris-fonde w-full sm:max-w-2xl sm:rounded-2xl rounded-t-2xl max-h-[95vh] overflow-y-auto">
                    ...
                    <div class="p-4 space-y-4 text-sm text-ivoire-text/80">
                        ...
                        <div class="bg-noir-profond/50 rounded-lg p-3">
                            ...
                            <p class="text-ivoire-text"><?php echo e($tattooer?->studio_name ?? $tattooer?->user?->name ?? 'Professionnel'); ?></p>
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tattooer?->address): ?> <p class="text-xs text-titane"><?php echo e($tattooer->address); ?></p> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tattooer?->siret): ?> <p class="text-xs text-titane">SIRET : <?php echo e($tattooer->siret); ?></p> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tattooer?->ars_number): ?> <p class="text-xs text-titane">ARS : <?php echo e($tattooer->ars_number); ?></p> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tattooer?->insurance_number): ?> <p class="text-xs text-titane">RC Pro : <?php echo e($tattooer->insurance_number); ?></p> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
