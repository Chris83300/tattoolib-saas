<?php $__env->startSection('content'); ?>
            ...
            <div class="bg-gris-fonde rounded-xl p-8 text-center border border-titane/20">
                ...
                <div class="bg-titane/30 rounded-lg p-4 mb-6 text-left">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <span class="text-beige-peau font-medium"><?php echo e(auth()->user()->name); ?></span>
                    </div>
                    <div class="flex items-center justify-between mb-2">
                        <span class="text-ivoire-text/60">Email:</span>
                        <span class="text-beige-peau font-medium"><?php echo e(auth()->user()->email); ?></span>
                    </div>
    ...
    <script>
        setTimeout(function() {
            window.location.href = "<?php echo e(route('tattooer.profile')); ?>";
        }, 10000);
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\livewire\tattooer\pending-verification-full.blade.php ENDPATH**/ ?>