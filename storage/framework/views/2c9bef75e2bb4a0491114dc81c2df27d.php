...
<div class="bg-gradient-to-r from-rouge-alerte/20 to-rouge-alerte/5 border border-rouge-alerte/30 rounded-xl p-4 mb-6">
    <div class="flex items-center justify-between gap-4">
        ...
        <a href="<?php echo e(route('pricing')); ?>" class="flex-shrink-0 px-4 py-2 text-sm font-medium bg-beige-peau text-noir-profond rounded-lg hover:bg-beige-peau/80 transition-colors">
            Voir les tarifs
        </a>
    </div>
</div>
...
<div class="bg-beige-peau/5 border border-beige-peau/20 rounded-xl p-4 mb-6">
    <div class="flex items-center justify-between gap-4">
        ...
        <a href="<?php echo e(route('pricing')); ?>" class="text-xs text-beige-peau hover:underline whitespace-nowrap">Voir les tarifs</a>
    </div>
</div>
...
<div class="bg-rouge-alerte/10 border border-rouge-alerte/30 rounded-xl p-6 mb-6 text-center">
    ...
    <a href="<?php echo e(route('pricing')); ?>" class="inline-block mt-4 px-6 py-2.5 text-sm font-medium bg-beige-peau text-noir-profond rounded-lg hover:bg-beige-peau/80 transition-colors">
