            ...
            <div class="flex items-center gap-6">
                ...
                <div class="relative">
                    <div class="w-24 h-24 rounded-full overflow-hidden border-2 border-cuivre/60 bg-beige-peau/10 shadow-lg shadow-cuivre/40">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->getFirstMediaUrl('avatar')): ?>
                            <img src="<?php echo e(auth()->user()->getFirstMediaUrl('avatar')); ?>" alt="Avatar"
                ...
                <div>
                    <h1 class="text-2xl font-bold text-ivoire-text">
                        <?php echo e($this->client->pseudo ?? ($this->user->pseudo ?? $this->user->first_name . ' ' . $this->user->last_name)); ?>

                    </h1>
                    <p class="text-ivoire-text/60 text-sm mt-1"><?php echo e($this->user->email); ?></p>
                    ...
                    <div class="flex items-center gap-4 mt-3">
                        <div class="flex items-center gap-2 text-sm">
                            ...
                            <span class="text-ivoire-text/80"><?php echo e($totalBookings); ?> demande(s)</span>
                        </div>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($upcomingAppointments > 0): ?>
                            <div class="flex items-center gap-2 text-sm">
                                ...
                                <span class="text-vert-succes font-semibold"><?php echo e($upcomingAppointments); ?> RDV à
                                    venir</span>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
    ...
    <div class="bg-gris-fonde rounded-xl border border-beige-peau/20 shadow-md shadow-beige-peau/20 mb-6" x-data="{ activeTab: 'demandes' }">
        ...
        <div>
            <div x-show="activeTab === 'demandes'" x-cloak>
                <?php echo $__env->make('livewire.client.profile-tabs.demandes', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
            <div x-show="activeTab === 'historique'" x-cloak>
                <?php echo $__env->make('livewire.client.profile-tabs.historique', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
            <div x-show="activeTab === 'favoris'" x-cloak>
                <?php echo $__env->make('livewire.client.profile-tabs.favoris', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\livewire\client\profile.blade.php ENDPATH**/ ?>