<?php $__env->startSection('title', 'Documents de Conformité - Ink&Pik'); ?>
    ...
    <div class="min-h-screen bg-noir-profond py-8">
        <div class="container-custom px-4">
            <div class="max-w-6xl mx-auto">
                ...
                <!-- Header -->
                <div class="mb-8">
                    <a href="<?php echo e(route('tattooer.compliance')); ?>"
                ...
                <div class="grid lg:grid-cols-2 gap-8">
                    ...
                    <div class="bg-gris-fonde rounded-xl p-8">
                        ...
                        <form action="<?php echo e(route('tattooer.compliance.documents.upload')); ?>" method="POST"
                    ...
                    <div class="bg-gris-fonde rounded-xl p-8">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($complianceRecords->isEmpty()): ?>
                        ...
                        <?php else: ?>
                            <div class="space-y-4">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $complianceRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="bg-noir-profond rounded-lg p-6 border border-titane/20">
                                        <div class="flex items-start justify-between">
                                            <div class="flex-1">
                                                <div class="flex items-center gap-3 mb-3">
                                                    <h3 class="text-lg font-bold text-ivoire-text">
                                                        <?php echo e($record->getCertificationLabel()); ?>

                                                    </h3>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($record->status):
                                                        case ('pending'): ?>
                                                            <span
                                                        ...
                                                        <?php default: ?>
                                                            <span
                                                                class="px-3 py-1 bg-titane/20 text-titane text-sm rounded-full"><?php echo e($record->status); ?></span>
                                                    <?php endswitch; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>

                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->certificate_number): ?>
                                                    <p class="text-ivoire-text/70 mb-1"><strong>Numéro :</strong>
                                                        <?php echo e($record->certificate_number); ?></p>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->training_organization): ?>
                                                    <p class="text-ivoire-text/70 mb-1"><strong>Organisme :</strong>
                                                        <?php echo e($record->training_organization); ?></p>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                                <p class="text-ivoire-text/70 mb-1"><strong>Obtenu le :</strong>
                                                    <?php echo e($record->obtained_at?->format('d/m/Y')); ?></p>

                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->expires_at): ?>
                                                    <p class="text-ivoire-text/70 mb-1"><strong>Expire le :</strong>
                                                        <?php echo e($record->expires_at->format('d/m/Y')); ?></p>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->verified_at): ?>
                                                    <p class="text-ivoire-text/70 mb-1"><strong>Validé le :</strong>
                                                        <?php echo e($record->verified_at->format('d/m/Y')); ?> par
                                                        <?php echo e($record->verifier?->name); ?></p>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                                <!-- Liens vers les fichiers -->
                                                <div class="flex gap-4 mt-4">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->certificate_file_path): ?>
                                                        <a href="<?php echo e(Storage::url($record->certificate_file_path)); ?>"
                                                            target="_blank"
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->ars_proof_file_path): ?>
                                                        <a href="<?php echo e(Storage::url($record->ars_proof_file_path)); ?>"
                                                            target="_blank"
                                                            class="text-beige-peau hover:underline text-sm flex items-center gap-1">
                                                            <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                                viewBox="0 0 24 24">
                                            ...
                                            <div class="flex gap-2 ml-4">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->status === 'pending'): ?>
                                                    <form
                                                        action="<?php echo e(route('tattooer.compliance.documents.delete', $record)); ?>"
                                                        method="POST"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tattoolib-saas\resources\views/tattooer/compliance-documents.blade.php ENDPATH**/ ?>