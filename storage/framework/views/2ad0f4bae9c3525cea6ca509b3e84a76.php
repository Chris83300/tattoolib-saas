        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white">
                    <?php echo e(auth()->user()->studio->name); ?>

                </h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Plan STUDIO • <?php echo e(auth()->user()->studio->artists->count()); ?> artiste(s)
                </p>
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['href' => ''.e(route('marketplace.studio.show', auth()->user()->studio->slug)).'','target' => '_blank','icon' => 'heroicon-o-arrow-top-right-on-square','color' => 'gray']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('marketplace.studio.show', auth()->user()->studio->slug)).'','target' => '_blank','icon' => 'heroicon-o-arrow-top-right-on-square','color' => 'gray']); ?>
                    Voir profil public
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['href' => '/admin/studio/resources/studio-artists/create','icon' => 'heroicon-o-plus']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => '/admin/studio/resources/studio-artists/create','icon' => 'heroicon-o-plus']); ?>
                    Ajouter un artiste
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6330f08526bbb3ce2a0da37da512a11f)): ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\filament\studio\pages\dashboard.blade.php ENDPATH**/ ?>