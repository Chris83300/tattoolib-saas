            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-gris-fonde rounded-xl p-8 mb-8 text-center">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->tattooer?->is_verified): ?>
                        <div class="mb-6">
                            <div
                                class="inline-flex items-center gap-2 bg-vert-succes/20 border border-vert-succes text-vert-succes px-6 py-3 rounded-full font-bold">
                    ...
                    <?php else: ?>
                        <div class="mb-6">
                            <div
                                class="inline-flex items-center gap-2 bg-titane/20 border border-titane text-titane px-6 py-3 rounded-full font-bold">
                            ...
                            <div class="flex items-start gap-4">
                                <div class="flex-shrink-0">
                                    <?php if(auth()->user()->tattooer?->siret): ?>
                                        <div
                                            class="w-8 h-8 bg-vert-succes text-noir-profond rounded-full flex items-center justify-center font-bold">
                                            ✓
                                        </div>
                                    <?php else: ?>
                                        <div
                                            class="w-8 h-8 bg-titane text-ivoire-text rounded-full flex items-center justify-center font-bold">
                                            1
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                <div class="flex-1">
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(route($tattooer->routePrefix() . '.profile')); ?>"
                                            class="text-beige-peau hover:underline">
...
<?php $component->withAttributes([]); ?>
                                        <a href="<?php echo e(route($tattooer->routePrefix() . '.compliance.documents')); ?>"
                                            class="text-noir-profond hover:no-underline block">
...
<?php endif; ?>
                    ...
                    <div class="text-center mt-8">
                        <a href="<?php echo e(route($tattooer->routePrefix() . '.compliance.documents')); ?>"
                            class="inline-block px-8 py-3 bg-beige-peau text-noir-profond font-bold rounded-lg hover:bg-beige-peau/90 transition-colors">
                            Gérer mes documents
                        </a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="mt-16">
                    ...
                    <div class="grid md:grid-cols-3 gap-6">
                        <div class="text-center">
                            <div
                                class="w-16 h-16 mx-auto mb-4 bg-beige-peau/10 rounded-full flex items-center justify-center">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tattoolib-saas\resources\views/tattooer/compliance.blade.php ENDPATH**/ ?>