                    ...
                    <form action="<?php echo e(route('tattooer.clients.update', $client)); ?>" method="POST">
                        ...
                        <div class="flex gap-2">
                            ...
                            <button type="button" @click="editMode = false"
                                class="px-4 py-2 border border-titane/30 text-titane rounded-lg text-sm hover:bg-noir-profond transition-colors">
                                Annuler
                            </button>
                        </div>
                    </form>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="file" name="consent_file" required accept=".pdf,.jpg,.jpeg,.png"
                                    class="w-full px-3 py-2 bg-noir-profond border border-titane/30 rounded-lg text-ivoire-text text-sm file:mr-2 file:py-1 file:px-2 file:rounded file:border-0 file:text-xs file:font-semibold file:bg-beige-peau file:text-noir-profond hover:file:bg-beige-peau/90">
                            </div>
                            <div>
                ...
                <div class="bg-gris-fonde rounded-xl p-4 md:p-6">
                    ...
                    <form action="<?php echo e(route('tattooer.clients.traceability.store', $client)); ?>" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-xs font-semibold text-ivoire-text/60 mb-1">Zone du corps *</label>
                                <input type="text" name="body_zone" required placeholder="Ex: Avant-bras gauche"
                                    class="w-full px-3 py-2 bg-noir-profond border border-titane/30 rounded-lg text-ivoire-text text-sm placeholder-titane focus:border-beige-peau">
                            </div>
                            <div class="md:col-span-2">
                                <label class="block text-xs font-semibold text-ivoire-text/60 mb-1">Description du tatouage *</label>
                                <textarea name="tattoo_description" required rows="2" placeholder="Description du motif, taille, style..."
                                    class="w-full px-3 py-2 bg-noir-profond border border-titane/30 rounded-lg text-ivoire-text text-sm placeholder-titane focus:border-beige-peau resize-none"></textarea>
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-ivoire-text/60 mb-1">Heure de début *</label>
                                <input type="time" name="procedure_start_time" required
                                    class="w-full px-3 py-2 bg-noir-profond border border-titane/30 rounded-lg text-ivoire-text text-sm focus:border-beige-peau">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-ivoire-text/60 mb-1">Heure de fin *</label>
                                <input type="time" name="procedure_end_time" required
                                    class="w-full px-3 py-2 bg-noir-profond border border-titane/30 rounded-lg text-ivoire-text text-sm focus:border-beige-peau">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-ivoire-text/60 mb-1">Équipement stérile</label>
                                <input type="text" name="sterile_equipment" placeholder="Gants, aiguilles stériles..."
                                    class="w-full px-3 py-2 bg-noir-profond border border-titane/30 rounded-lg text-ivoire-text text-sm placeholder-titane focus:border-beige-peau">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-ivoire-text/60 mb-1">Produits de soin</label>
                                <input type="text" name="aftercare_products" placeholder="Bepanthen, Cicaplast..."
                                    class="w-full px-3 py-2 bg-noir-profond border border-titane/30 rounded-lg text-ivoire-text text-sm placeholder-titane focus:border-beige-peau">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-ivoire-text/60 mb-1">Salle</label>
                                <input type="text" name="room_number" placeholder="Salle 1"
                                    class="w-full px-3 py-2 bg-noir-profond border border-titane/30 rounded-lg text-ivoire-text text-sm placeholder-titane focus:border-beige-peau">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-ivoire-text/60 mb-1">N° lot autoclave</label>
                                <input type="text" name="autoclave_batch_number" placeholder="ABC123"
                                    class="w-full px-3 py-2 bg-noir-profond border border-titane/30 rounded-lg text-ivoire-text text-sm placeholder-titane focus:border-beige-peau">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-ivoire-text/60 mb-1">Date test autoclave</label>
                                <input type="date" name="autoclave_test_date"
                                    class="w-full px-3 py-2 bg-noir-profond border border-titane/30 rounded-lg text-ivoire-text text-sm focus:border-beige-peau">
                            </div>
                            <div class="md:col-span-2">
                                <label class="block text-xs font-semibold text-ivoire-text/60 mb-1">Notes procédure</label>
                                <textarea name="procedure_notes" rows="2" placeholder="Notes sur le déroulement de la séance..."
                                    class="w-full px-3 py-2 bg-noir-profond border border-titane/30 rounded-lg text-ivoire-text text-sm placeholder-titane focus:border-beige-peau resize-none"></textarea>
                            </div>
                            <div class="md:col-span-2">
                                <label class="block text-xs font-semibold text-ivoire-text/60 mb-1">État du client</label>
                                <textarea name="client_condition_notes" rows="2" placeholder="État de santé, réactions, allergies..."
                                    class="w-full px-3 py-2 bg-noir-profond border border-titane/30 rounded-lg text-ivoire-text text-sm placeholder-titane focus:border-beige-peau resize-none"></textarea>
                            </div>
                            <div class="md:col-span-2">
                                <label class="block text-xs font-semibold text-ivoire-text/60 mb-1">Notes équipement</label>
                                <textarea name="equipment_notes" rows="2" placeholder="Notes sur le matériel utilisé..."
                                    class="w-full px-3 py-2 bg-noir-profond border border-titane/30 rounded-lg text-ivoire-text text-sm placeholder-titane focus:border-beige-peau resize-none"></textarea>
                            </div>
                        </div>
                        <div class="mt-4">
                            <button type="submit"
                                class="px-6 py-3 bg-beige-peau text-noir-profond rounded-lg font-bold hover:bg-beige-peau/90 transition-colors">
                    ...
                    <form action="<?php echo e(route('tattooer.clients.photos.upload', $client)); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="file" name="photos[]" multiple accept=".jpg,.jpeg,.png,.webp" onchange="previewFiles(this)"
                                class="w-full px-3 py-2 bg-noir-profond border border-titane/30 rounded-lg text-ivoire-text text-sm file:mr-2 file:py-1 file:px-2 file:rounded file:border-0 file:text-xs file:font-semibold file:bg-beige-peau file:text-noir-profond hover:file:bg-beige-peau/90">
                            <p class="text-xs text-titane mt-1">Format : JPG, PNG, WEBP | Taille max : 5MB par photo | Max 10 photos</p>
                            <div class="upload-preview flex gap-2 mt-2 flex-wrap"></div>
                        </div>
                        <div>
                            <button type="submit"
