    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex gap-3">
                <!-- Recherche -->
                <form action="<?php echo e(route($tattooer->routePrefix() . '.clients')); ?>" method="GET" class="flex gap-3">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isTattooer() ? auth()->user()->tattooer?->isPro() : auth()->user()->piercer?->isPro()): ?>
                    <a href="<?php echo e(route($tattooer->routePrefix() . '.clients.create')); ?>"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($clients->count() > 0): ?>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route($tattooer->routePrefix() . '.client.show', $client)); ?>"
    ...
    $avatarUrl = $client->getFirstMediaUrl('avatar');
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-titane mt-0.5">
                                    <?php echo e($client->artisan_stats->total_requests); ?>

                                    demande<?php echo e($client->artisan_stats->total_requests > 1 ? 's' : ''); ?>

                                    <?php if($client->artisan_stats->completed > 0): ?>
                                        · <?php echo e($client->artisan_stats->completed); ?>

                                        terminée<?php echo e($client->artisan_stats->completed > 1 ? 's' : ''); ?>
                        ...
                        <div class="flex items-center justify-between text-xs text-titane border-t border-titane/20 pt-2">
                            <span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($client->artisan_stats->total_paid > 0): ?>
                                    💰 <?php echo e(number_format($client->artisan_stats->total_paid, 0)); ?>€ versés
                                <?php else: ?>
                                    Aucun paiement
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </span>
                            <span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($client->artisan_stats->last_request_at): ?>
                                    <?php echo e(\Carbon\Carbon::parse($client->artisan_stats->last_request_at)->diffForHumans()); ?>
...
<?php echo $__env->make('layouts.tattooer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\tattooer\clients.blade.php ENDPATH**/ ?>