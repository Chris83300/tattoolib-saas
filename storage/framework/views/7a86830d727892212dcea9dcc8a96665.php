<div x-data="{ 
    showAcceptModal: <?php if ((object) ('showAcceptModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showAcceptModal'->value()); ?>')<?php echo e('showAcceptModal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showAcceptModal'); ?>')<?php endif; ?> 
            ...
            <div class="mb-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 0; $i < 3; $i++): ?>
                    <div class="flex gap-2 mb-2">
                        <input type="date" wire:model="proposedDates.<?php echo e($i); ?>.date"
                               min="<?php echo e(now()->addDays(3)->format('Y-m-d')); ?>"
                               class="flex-1 border rounded-lg px-3 py-2">
                        <select wire:model="proposedDates.<?php echo e($i); ?>.period" class="border rounded-lg px-3 py-2">
...
<?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\livewire\tattooer\request-management.blade.php ENDPATH**/ ?>