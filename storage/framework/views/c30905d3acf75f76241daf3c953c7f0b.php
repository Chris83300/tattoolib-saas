    ...
    <div class="container-custom px-4">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-gris-fonde rounded-xl p-8 mb-8 text-center">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->pierceur?->is_verified): ?>
                    <div class="mb-6">
                ...
                <div class="bg-gris-fonde rounded-xl p-6">
                    <div class="flex items-start gap-4">
                        <div class="flex-shrink-0">
                            <?php if(auth()->user()->pierceur?->siret): ?>
                        ...
                        <div class="flex-1">
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('pierceur.profile')); ?>" class="text-beige-peau hover:underline">
            ...
            <div class="text-center mt-8">
                <a href="<?php echo e(route('pierceur.profile')); ?>" class="inline-block px-8 py-3 bg-beige-peau text-noir-profond font-bold rounded-lg hover:bg-beige-peau/90 transition-colors">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\pierceur\compliance.blade.php ENDPATH**/ ?>