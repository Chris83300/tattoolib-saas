    ...
    <div class="container-custom px-4">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="flex justify-between items-center mb-8">
                ...
                <a href="<?php echo e(route('pierceur.dashboard')); ?>" class="text-ivoire-text/70 hover:text-beige-peau transition-colors">
                    ← Retour au dashboard
                </a>
            </div>
...
<?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\livewire\pierceur\messages.blade.php ENDPATH**/ ?>