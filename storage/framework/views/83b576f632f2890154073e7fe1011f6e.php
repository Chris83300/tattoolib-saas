                        ...
                        <div
                            ...
                            <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                                ...
                                <div class="flex-1">
                                        ...
                                        <?php elseif($bookingRequest->estimated_total_price): ?>
                                            <div>
                                                <span class="text-ivoire-text/70 block text-sm mb-1">Estimation
                                                    tattoo</span>
                                                <span
                                                    class="text-ivoire-text font-medium"><?php echo e(number_format($bookingRequest->estimated_total_price, 0)); ?>€</span>
                                            </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <div>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bookingRequest->bookable): ?>
                                        <div class="flex items-center gap-3 text-sm text-ivoire-text/70 mb-4">
                                            ...
                                            <div>
                                                <span
                                                    class="font-medium text-ivoire-text"><?php echo e($bookingRequest->bookable->user->name); ?></span>
                                                <div class="text-xs">
                                ...
                                <div class="flex flex-col gap-2 lg:w-48">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bookingRequest->status === 'deposit_paid'): ?>
                                    ...
                                    <?php elseif($bookingRequest->status === 'rejected'): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tattoolib-saas\resources\views/client/booking-requests.blade.php ENDPATH**/ ?>