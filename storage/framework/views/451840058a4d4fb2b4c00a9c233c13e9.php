<?php $__env->startSection('legal-title', 'Mentions légales'); ?>
<?php $__env->startSection('legal-date', '01/03/2026'); ?>
...
<p>Le traitement des données personnelles est décrit dans notre <a href="<?php echo e(route('legal.politique-confidentialite')); ?>">Politique de confidentialité</a>, conformément au Règlement Général sur la Protection des Données (RGPD — Règlement UE 2016/679) et à la loi Informatique et Libertés du 6 janvier 1978 modifiée.</p>

<h2>7. Cookies</h2>

<p>Le site utilise des cookies. Pour en savoir plus, consultez notre <a href="<?php echo e(route('legal.politique-cookies')); ?>">Politique de cookies</a>.</p>
...
<?php echo $__env->make('legal.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\legal\mentions-legales.blade.php ENDPATH**/ ?>