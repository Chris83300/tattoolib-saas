            ...
            <div class="max-w-6xl mx-auto">
                <div class="text-center mb-8">
                    ...
                    <p class="text-ivoire-text/70">
                        <?php echo e($studios->count()); ?> studio<?php echo e($studios->count() > 1 ? 's' : ''); ?> référencé<?php echo e($studios->count() > 1 ? 's' : ''); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $studios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $studio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-gris-fonde rounded-2xl border border-titane/20 overflow-hidden hover:border-beige-peau/40 transition-all">
                                ...
                                <div class="h-40 bg-gradient-to-br from-beige-peau/20 via-titane/30 to-noir-profond relative overflow-hidden">
                                    ...
                                    <div class="absolute bottom-0 left-4 translate-y-1/2 w-16 h-16 rounded-xl border-2 border-titane/30 bg-gris-fonde overflow-hidden flex items-center justify-center shadow-lg">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($studio->getFirstMediaUrl('logo')): ?>
                                            <img src="<?php echo e($studio->getFirstMediaUrl('logo')); ?>" alt="<?php echo e($studio->name); ?>" class="w-full h-full object-cover">
                                        <?php else: ?>
                                ...
                                <div class="p-4 pt-10">
                                    <h3 class="text-beige-peau font-semibold text-lg mb-1"><?php echo e($studio->name); ?></h3>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($studio->city): ?>
                                        <p class="text-titane text-sm mb-2">📍 <?php echo e($studio->city); ?><?php echo e($studio->postal_code ? ' (' . $studio->postal_code . ')' : ''); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($studio->description || $studio->bio): ?>
                                        <p class="text-ivoire-text/70 text-sm mb-3 line-clamp-2">
                                            <?php echo e(\Illuminate\Support\Str::limit($studio->description ?? $studio->bio, 100)); ?>

                                        </p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <p class="text-xs text-titane mb-4">
                                        👥 <?php echo e($studio->studioArtists->count()); ?> artiste<?php echo e($studio->studioArtists->count() > 1 ? 's' : ''); ?>

                                    </p>
                                    <a href="<?php echo e(route('studio.public.show', $studio->slug)); ?>"
