    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="bg-gris-fonde rounded-xl p-6">
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('tattooer.clients')); ?>" class="p-2 rounded-lg hover:bg-noir-profond transition-colors">
        ...
        <!-- Formulaire -->
        <div class="bg-gris-fonde rounded-xl p-6">
            <form action="<?php echo e(route('tattooer.clients.store')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
