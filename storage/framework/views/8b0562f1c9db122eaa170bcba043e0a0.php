...
<?php endif; ?>
                            ...
                            <div>
                                ...
                                <select name="artisan_type"
                                    ...
                                    <option value="bodemodeur"
                                        <?php echo e(($filters['artisan_type'] ?? '') === 'bodemodeur' ? 'selected' : ''); ?>>
                                        Bodemodeurs
                                    </option>
                                    <option value="studio"
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($filters['artisan_type'] ?? '') === 'studio'): ?>
        <!-- Studios -->
                ...
                <div class="max-w-6xl mx-auto">
                    <div class="text-center mb-8">
                        ...
                        <p class="text-ivoire-text/70">
                            <?php echo e($studios->count()); ?> studio<?php echo e($studios->count() > 1 ? 's' : ''); ?>

                            référencé<?php echo e($studios->count() > 1 ? 's' : ''); ?>

                        </p>
                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($studios->isEmpty()): ?>
                        <p class="text-center text-titane py-12">Aucun studio trouvé pour ces critères.</p>
                    <?php else: ?>
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $studios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $studio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if (isset($component)) { $__componentOriginal945f0c67b42bc5875b161fb70b1b7d93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal945f0c67b42bc5875b161fb70b1b7d93 = $attributes; } ?>
<?php $component = App\View\Components\Ui\SalonCard::resolve(['salon' => $studio] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.salonCard'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\App\View\Components\Ui\SalonCard::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal945f0c67b42bc5875b161fb70b1b7d93)): ?>
<?php $attributes = $__attributesOriginal945f0c67b42bc5875b161fb70b1b7d93; ?>
<?php unset($__attributesOriginal945f0c67b42bc5875b161fb70b1b7d93); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal945f0c67b42bc5875b161fb70b1b7d93)): ?>
<?php $component = $__componentOriginal945f0c67b42bc5875b161fb70b1b7d93; ?>
<?php unset($__componentOriginal945f0c67b42bc5875b161fb70b1b7d93); ?>
<?php endif; ?>
