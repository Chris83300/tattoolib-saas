    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="bg-gris-fonde rounded-xl p-6 border border-titane/20">
            ...
            <?php else: ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($daysLeft > 0): ?>
                    <p class="text-sm text-titane mt-1">🎁 Essai gratuit — <?php echo e($daysLeft); ?>

                        jour<?php echo e($daysLeft > 1 ? 's' : ''); ?> restant<?php echo e($daysLeft > 1 ? 's' : ''); ?></p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->isFree()): ?>
