...
# Bienvenue sur Ink&Pik, <?php echo new \Illuminate\Support\EncodedHtmlString($name); ?> !

**<?php echo new \Illuminate\Support\EncodedHtmlString($studio->name); ?>** a créé votre compte professionnel en tant que **<?php echo new \Illuminate\Support\EncodedHtmlString($artisanType); ?>**.

Voici vos identifiants de connexion :

- **Email** : <?php echo new \Illuminate\Support\EncodedHtmlString($email); ?>

- **Mot de passe temporaire** : <?php echo new \Illuminate\Support\EncodedHtmlString($tempPassword); ?>
