...
<div class="info-grid">
    <div class="info-col">
        ...
        <div class="info-value"><?php echo e($consentForm->client_birth_date?->format('d/m/Y') ?? ($consentForm->birth_date?->format('d/m/Y') ?? '—')); ?></div>
        <div class="info-label">Pièce d'identité</div>
        <div class="info-value"><?php echo e($consentForm->client_id_type ?? ($consentForm->id_document_type ?? '—')); ?> — <?php echo e($consentForm->client_id_number ?? ($consentForm->id_document_number ?? '—')); ?></div>
    </div>
    <div class="info-col">
...
<div class="alert-box">
    <strong>Client mineur :</strong> <?php echo e($consentForm->parent_name ?? '—'); ?> (<?php echo e($consentForm->parent_relation ?? '—'); ?>) — N° pièce d'identité : <?php echo e($consentForm->parent_id_number ?? '—'); ?>
...
<div class="info-grid">
    <div class="info-col">
        ...
        <div class="info-value"><?php echo e($artisan?->user?->name ?? '—'); ?></div>
        <div class="info-label">SIRET</div>
        <div class="info-value"><?php echo e($artisan?->siret ?? '—'); ?></div>
    </div>
    <div class="info-col">
        <div class="info-label">Studio</div>
        <div class="info-value"><?php echo e($consentForm->studio?->name ?? 'Indépendant'); ?></div>
    </div>
</div>
...
<div class="info-grid">
    ...
    <div class="info-col">
        ...
        <div class="info-value"><?php echo e(number_format($consentForm->total_price / 100, 2, ',', ' ')); ?> €</div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
</div>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($consentForm->medical_allergies_detail): ?><td class="text-small"><?php echo e($consentForm->medical_allergies_detail); ?></td><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($consentForm->medical_skin_disease_detail): ?><td class="text-small"><?php echo e($consentForm->medical_skin_disease_detail); ?></td><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </tr>
        <tr>
            <td>VIH / Hépatite</td>
...
<ul class="checklist">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($consentForm->confirm_medical_sincere): ?> <li>Informations médicales fournies sincèrement et complètement</li> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($consentForm->confirm_risks_informed): ?> <li>Informé(e) des risques liés à la prestation</li> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($consentForm->confirm_info_sheet_read): ?> <li>Fiche d'information lue et comprise</li> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($consentForm->confirm_aftercare_received): ?> <li>Consignes de soins post-prestation reçues</li> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($consentForm->confirm_not_intoxicated): ?> <li>Déclare ne pas être sous l'emprise de substances</li> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($consentForm->confirm_over_18_or_authorized): ?> <li>Majeur(e) ou autorisé(e) par un représentant légal</li> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($consentForm->image_authorization): ?> <li>Autorise la prise de photos à des fins professionnelles</li> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</ul>
    ...
    <div class="signature-col">
        ...
        <div class="signature-line">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($consentForm->signed_at): ?>
                <div class="text-small text-muted" style="padding-top: 5px;">Signé le <?php echo e($consentForm->signed_at->format('d/m/Y à H:i')); ?></div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
