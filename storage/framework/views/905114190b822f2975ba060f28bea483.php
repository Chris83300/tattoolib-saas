<div class="container mx-auto max-w-4xl p-6">
    ...
    <div class="bg-gris-fonde rounded-xl p-6 mb-8">
        <div class="flex items-center gap-4 mb-6">
            <a href="<?php echo e(route('tattooer.dashboard')); ?>" class="text-ivoire-text hover:text-beige-peau transition-colors">
    ...
    <div class="bg-noir-profond rounded-xl p-8 shadow-xl">
        ...
        <div class="flex items-center gap-6 mb-8">
            <div class="w-24 h-24 rounded-full overflow-hidden bg-beige-peau/10 border-4 border-beige-peau/20">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->tattooer->getFirstMediaUrl('avatar') &&
                        auth()->user()->tattooer->getFirstMediaUrl('avatar') !== '/images/default-tattooer-avatar.png'): ?>
                    <img src="<?php echo e(auth()->user()->getFirstMediaUrl('avatar', 'thumb')); ?>" alt="Photo de profil"
            ...
            <div class="flex-1">
                ...
                <form wire:submit="uploadAvatar" class="mb-4">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($testAvatar): ?>
                        <div class="text-vert-succes text-sm mt-2">
                            ✅ Fichier sélectionné: <?php echo e($testAvatar->getClientOriginalName()); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <p class="text-ivoire-text/50 text-xs mt-1"><?php echo e(strlen($bio)); ?>/1000 caractères</p>
                </div>
            </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artisanUser?->studio_id): ?>
            <form wire:submit="updateProfessional" class="mt-6 pt-6 border-t border-titane/20">
                ...
                <div class="mb-4">
                    <label class="block text-ivoire-text font-medium mb-2">
                        Numéro SIRET
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($siretRequired): ?>
                    ...
                    <input type="text" wire:model="siret" maxlength="14" placeholder="14 chiffres"
                        class="w-full px-4 py-2 bg-noir-profond border border-titane/20 rounded-lg text-ivoire-text focus:border-beige-peau focus:outline-none"
                        <?php echo e($siretRequired ? 'required' : ''); ?>>
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        <p class="text-rouge-alerte text-sm mt-1"><?php echo e($message); ?></p>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\livewire\tattooer\settings-final.blade.php ENDPATH**/ ?>