    ...
    <div class="flex min-h-screen max-w-full overflow-x-hidden">
        ...
        <aside
            ...
            <div class="p-6 border-b border-titane/20">
                <a href="<?php echo e(route('client.dashboard')); ?>" class="flex items-center gap-3">
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                <a href="<?php echo e(route('home')); ?>"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg <?php echo e(request()->routeIs('home') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond'); ?> transition-colors">
                ...
                <a href="<?php echo e(route('marketplace.index')); ?>"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg <?php echo e(request()->routeIs('marketplace.*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond'); ?> transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('client.booking-requests')); ?>"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg <?php echo e(request()->routeIs('client.booking-requests*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond'); ?> transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('client.messages')); ?>"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg <?php echo e(request()->routeIs('client.messages*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond'); ?> transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($clientUnreadCount ?? 0) > 0): ?>
                        <span
                            class="ml-auto bg-rouge-alerte text-noir-profond px-2 py-0.5 rounded-full text-xs font-bold">
                            <?php echo e($clientUnreadCount > 99 ? '99+' : $clientUnreadCount); ?>
                ...
                <a href="<?php echo e(route('client.reviews')); ?>"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg <?php echo e(request()->routeIs('client.reviews*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond'); ?> transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('client.complaints')); ?>"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg <?php echo e(request()->routeIs('client.complaints*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond'); ?> transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('client.profile')); ?>"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg <?php echo e(request()->routeIs('client.profile') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond'); ?> transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('client.settings')); ?>"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg <?php echo e(request()->routeIs('client.settings') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond'); ?> transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    // En cas d'erreur, on continue sans avatar
                ...
                <div class="flex items-center gap-3 p-3 rounded-lg bg-noir-profond">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($client): ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($avatarUrl): ?>
                            <img src="<?php echo e($avatarUrl); ?>" alt="Avatar" class="w-10 h-10 rounded-full">
                        <?php else: ?>
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-ivoire-text font-semibold truncate"><?php echo e($user->name); ?></p>
        ...
        <nav class="lg:hidden fixed bottom-0 left-0 right-0 bg-gris-fonde border-t border-titane/20 z-50">
            <div class="grid grid-cols-5 gap-1 p-2">
                <a href="<?php echo e(route('home')); ?>"
                    class="flex flex-col items-center gap-1 p-2 rounded-lg <?php echo e(request()->routeIs('home') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text'); ?>">
                ...
                <a href="<?php echo e(route('marketplace.index')); ?>"
                    class="flex flex-col items-center gap-1 p-2 rounded-lg <?php echo e(request()->routeIs('marketplace.*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text'); ?>">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2zm14 0V9a2 2 0 00-2-2M5 11a2 2 0 00-2 2v6a2 2 0 002 2h14a2 2 0 002-2v-6a2 2 0 00-2-2z">
                        </path>
                    </svg>
                    <span class="text-[10px] font-semibold whitespace-nowrap">Marketplace</span>
                </a>

                <a href="<?php echo e(route('client.booking-requests')); ?>"
                    class="flex flex-col items-center gap-1 p-2 rounded-lg <?php echo e(request()->routeIs('client.booking-requests*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text'); ?>">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002 2M9 5a2 2 0 012-2h2a2 2 0 012 2">
                        </path>
                ...
                <a href="<?php echo e(route('client.messages')); ?>"
                    class="flex flex-col items-center gap-1 p-2 rounded-lg relative <?php echo e(request()->routeIs('client.messages*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text'); ?>">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z">
                        </path>
                ...
                <button onclick="toggleMobileMenu()"
                    class="flex flex-col items-center gap-1 p-2 rounded-lg text-ivoire-text relative">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <!-- Menu déroulant Plus -->
            <div id="mobileMenu"
                class="hidden absolute bottom-full left-0 right-0 bg-gris-fonde border-t border-titane/20 shadow-lg">
                <div class="p-2 space-y-1">
                    <a href="<?php echo e(route('client.reviews')); ?>"
                        class="flex items-center gap-3 p-3 rounded-lg <?php echo e(request()->routeIs('client.reviews*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond'); ?> transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z">
                            </path>
                        </svg>
                        <span class="text-sm font-medium">Mes avis</span>
                    </a>

                    <a href="<?php echo e(route('client.complaints')); ?>"
                        class="flex items-center gap-3 p-3 rounded-lg <?php echo e(request()->routeIs('client.complaints*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond'); ?> transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4.5c-.77-.833-2.694-.833-3.464 0L3.34 16.5c-.77.833.192 2.5 1.732 2.5z">
                            </path>
                        </svg>
                        <span class="text-sm font-medium">Réclamations</span>
                    </a>

                    <a href="<?php echo e(route('client.profile')); ?>"
                        class="flex items-center gap-3 p-3 rounded-lg <?php echo e(request()->routeIs('client.profile') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond'); ?> transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z">
                            </path>
                    ...
                    <a href="<?php echo e(route('client.settings')); ?>"
                        class="flex items-center gap-3 p-3 rounded-lg <?php echo e(request()->routeIs('client.settings') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond'); ?> transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 002.573 1.066c1.543-.94 3.31-.826 2.37-2.37.996.608 2.296.07 2.572-1.065z">
                            </path>
...
<?php /**PATH C:\laragon\www\tattoolib-saas\resources\views/layouts/client.blade.php ENDPATH**/ ?>