<?php $__env->startSection('title', 'Réinitialiser le mot de passe - Ink&Pik'); ?>
...
<div class="min-h-screen bg-noir-profond flex items-center justify-center px-4 py-12">
    <div class="max-w-md w-full">
        ...
        <!-- Formulaire -->
        <form action="<?php echo e(route('password.reset')); ?>" method="POST" class="bg-gris-fonde rounded-xl p-6 space-y-4">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>