...
<?php $__env->startSection('content'); ?>
    ...
    <section class="min-h-screen bg-noir-profond overflow-hidden flex items-center justify-center px-4">
        <div class="text-center max-w-4xl">
            <!-- Titre principal -->
            <h1 class="text-4xl md:text-6xl font-Satoshi font-bold text-titane mb-6">
                L'outil métier pour les artistes<br>
                <span class="text-beige-peau">qui prennent leur travail au sérieux</span>
            </h1>
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-12 max-w-3xl mx-auto">
                <div class="text-center">
                    ...
                    <p class="text-ivoire-text/90 text-sm">Acompte obligatoire pour tout rendez-vous et dessins</p>
                </div>
                <div class="text-center">
                    <div class="text-cuivre font-bold text-lg mb-2">Temps gagné</div>
                    <p class="text-ivoire-text/90 text-sm">Automatisation de la gestion client</p>
                </div>
                <div class="text-center">
                    <div class="text-cuivre font-bold text-lg mb-2">Cadre pro</div>
                    <p class="text-ivoire-text/90 text-sm">Outils pensés pour votre métier</p>
                </div>
            </div>
            ...
            <div class="max-w-6xl mx-auto">
                <div class="text-center mb-16">
                    <h2 class="text-4xl md:text-5xl font-display font-bold text-ivoire-text mb-6">
                        <span class="text-cuivre">Un outil métier,</span>
                        <br><span class="text-titane">pas un réseau social</span>
                    </h2>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                    <!-- Booking intelligent -->
                    <div class="bg-noir-profond border border-beige-peau/40 rounded-xl p-6">
                        <div class="w-12 h-12 bg-beige-peau/10 rounded-full btn-shadow flex items-center justify-center mb-4">
                        ...
                        <h3 class="text-xl font-bold text-cuivre mb-3">Booking intelligent</h3>
                        <p class="text-ivoire-text/70 mb-3">Acompte obligatoire, validation de projet avant ouverture du
                            chat.</p>
                        <ul class="text-ivoire-text text-sm space-y-1">
                    ...
                    <div class="bg-noir-profond border border-beige-peau/40 rounded-xl p-6">
                        ...
                        <h3 class="text-xl font-bold text-cuivre mb-3">Formulaire projet</h3>
                    ...
                    <!-- Chat cadré -->
                    <div class="bg-noir-profond rounded-xl border border-beige-peau/40 p-6">
                        <div class="w-12 h-12 bg-beige-peau/10 rounded-full btn-shadow flex items-center justify-center mb-4">
                            <svg class="w-6 h-6 text-cuivre" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <h3 class="text-xl font-bold text-cuivre mb-3">Chat projet</h3>
                        ...
                        <ul class="text-ivoire-text text-sm space-y-1">
                            ...
                            <li>• Suppression à 30 jours après RDV</li>
                    ...
                    <div class="bg-noir-profond border border-beige-peau/40 rounded-xl p-6">
                        ...
                        <h3 class="text-xl font-bold text-cuivre mb-3">Fiche client <span class="text-ivoire-text/50 text-sm"> (plan Pro uniquement)</span></h3>
                    ...
                    <div class="bg-noir-profond rounded-xl border border-beige-peau/40 p-6">
                        ...
                        <h3 class="text-xl font-bold text-cuivre mb-3">Avis vérifiés</h3>
                    ...
                    <div class="bg-noir-profond rounded-xl border border-beige-peau/40 p-6">
                        ...
                        <h3 class="text-xl font-bold text-cuivre mb-3">Portfolio intégré</h3>
                ...
                <div class="text-center mb-12">
                    <h3 class="text-3xl font-bold text-beige-peau mb-4">Fonctionnalités avancées <br> <span class="text-titane">(plans Pro & Salon)</span></h3>
                    <p class="text-ivoire-text/70">Pour les professionnels qui veulent aller plus loin</p>
                </div>

                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="text-center">
                        <div class="w-16 h-16 bg-beige-peau/10 rounded-full flex items-center justify-center mx-auto mb-3 btn-shadow">
                            <svg class="w-8 h-8 text-beige-peau" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <h4 class="font-bold text-beige-peau mb-2">Traçabilité complète</h4>
                        <p class="text-ivoire-text text-sm">Encres, aiguilles, lots</p>
                    </div>

                    <div class="text-center">
                        <div class="w-16 h-16 bg-beige-peau/10 rounded-full btn-shadow flex items-center justify-center mx-auto mb-3">
                            <svg class="w-8 h-8 text-beige-peau" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <h4 class="font-bold text-beige-peau mb-2">Historique long terme</h4>
                        <p class="text-ivoire-text text-sm">Conservation des échanges</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <h4 class="font-bold text-beige-peau mb-2">Statistiques</h4>
                        <p class="text-ivoire-text text-sm">Performance et chiffre d'affaires</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <h4 class="font-bold text-beige-peau mb-2">Gestion multi-agendas</h4>
                        <p class="text-ivoire-text text-sm">Pour les salons</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-noir-profond">
        <div class="container-custom px-4">
            <div class="text-center max-w-3xl mx-auto">
                <h2 class="text-4xl md:text-5xl font-Satoshi font-bold text-ivoire-text mb-6">
                   <span class="text-titane"> Ink</span> <span class="text-beige-peau">&Pik</span><br>
                    <span class="text-ivoire-text text-2xl">Conçu par et pour les professionnels</span>
                </h2>
                <p class="text-xl text-ivoire-text/90 mb-8">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['variant' => 'primary','size' => 'lg','href' => '/contact']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','size' => 'lg','href' => '/contact']); ?>
                        Nous contacter
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['variant' => 'secondary','size' => 'lg','href' => '/register']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'secondary','size' => 'lg','href' => '/register']); ?>
                        Créer mon compte
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
