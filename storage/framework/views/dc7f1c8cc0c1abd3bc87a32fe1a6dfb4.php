    ...
    <div class="container-custom px-4">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="flex justify-between items-center mb-8">
                ...
                <a href="<?php echo e(route('studio.dashboard')); ?>" class="text-ivoire-text/70 hover:text-beige-peau transition-colors">
                    ← Retour au dashboard
                </a>
            </div>
            ...
            <div class="bg-gris-fonde rounded-xl p-6">
                <div class="text-center py-12">
                    ...
                    <h2 class="text-xl font-bold text-ivoire-text mb-2">
                        Calendrier Studio en cours de développement
                    </h2>
...
<?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\livewire\studio\calendar.blade.php ENDPATH**/ ?>