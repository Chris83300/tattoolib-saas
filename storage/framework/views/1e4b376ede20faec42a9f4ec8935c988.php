    ...
    <div class="flex min-h-screen max-w-full overflow-x-hidden">
        ...
        <aside
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                <button type="button" onclick="openStudioMoreMenu()"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg <?php echo e(request()->routeIs('studio.settings') || request()->routeIs('studio.billing') || request()->routeIs('studio.stats') || request()->routeIs('studio.profile*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond'); ?> transition-colors">
        ...
        <nav class="lg:hidden fixed bottom-0 left-0 right-0 bg-gris-fonde border-t border-titane/20 z-50">
            <div class="grid grid-cols-6 gap-1 p-2">
                ...
                <a href="<?php echo e(route('studio.clients.index')); ?>"
                    class="flex flex-col items-center gap-1 p-2 rounded-lg <?php echo e(request()->routeIs('studio.clients*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text'); ?>">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 017.356-1.857M7 20h10">
                        </path>
...
<?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\layouts\livewire-studio.blade.php ENDPATH**/ ?>