        ...
        <div class="max-w-4xl w-full">
            ...
            <div class="text-center mb-10">
                ...
                <p class="text-beige-peau">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->get('type') === 'piercer'): ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div
                    ...
                    <div class="text-center">
                        <a href="<?php echo e(request()->get('type') === 'piercer' ? route('register.pierceur', ['plan' => 'starter']) : route('register.tattooer', ['plan' => 'starter'])); ?>"
                ...
                <div class="bg-gris-fonde border-2 border-beige-peau rounded-xl p-6 relative overflow-hidden group">
                    ...
                    <div class="space-y-3 mb-6">
                        ...
                        <div class="text-center">
                            <a href="<?php echo e(request()->get('type') === 'piercer' ? route('register.pierceur', ['plan' => 'pro']) : route('register.tattooer', ['plan' => 'pro'])); ?>"
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\auth\register-plan.blade.php ENDPATH**/ ?>