            ...
            <div class="mb-6">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-ivoire-text/70 mt-1">Artiste: <?php echo e($bookingRequest->bookable->user->first_name); ?>

                            <?php echo e($bookingRequest->bookable->user->last_name); ?></p>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-titane/20 rounded-xl p-6 border border-titane/30">
                        ...
                        <div class="flex items-center gap-3 mb-4">
                            <div class="w-12 h-12 rounded-full overflow-hidden bg-beige-peau/10">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bookingRequest->bookable->user->getFirstMediaUrl('avatar')): ?>
                                    <img src="<?php echo e($bookingRequest->bookable->user->getFirstMediaUrl('avatar')); ?>"
                                        alt="Avatar de <?php echo e($bookingRequest->bookable->user->first_name); ?>"
                            ...
                            <div>
                                <p class="font-semibold text-ivoire-text"><?php echo e($bookingRequest->bookable->user->first_name); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($bookingRequest->status->value, [
                        ...
                        <div
                            ...
                            <div class="space-y-4">
                                ...
                                <!-- 📅 Sélection de dates -->
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bookingRequest->status === 'deposit_paid' && $bookingRequest->proposed_dates && !$bookingRequest->confirmed_date): ?>
                                    ...
                                    <div class="bg-gris-fonde rounded-xl p-4 border border-beige-peau/20 mt-4">
                                        ...
                                        <div class="space-y-2">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $bookingRequest->proposed_dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <button type="button"
                                                    wire:click="selectProposedDate(<?php echo e($index); ?>)"
                                                    wire:confirm="Confirmer la date du <?php echo e($proposalDate->translatedFormat('l d F Y')); ?> (<?php echo e(strip_tags($periodLabel)); ?>) ?"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tattoolib-saas\resources\views/client/booking-request-show.blade.php ENDPATH**/ ?>