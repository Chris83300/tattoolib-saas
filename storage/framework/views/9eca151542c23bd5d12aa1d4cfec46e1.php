<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 mb-6">
    ...
    <a href="<?php echo e(route('client.booking-requests', ['status' => 'pending'])); ?>"
        ...
        <div class="flex items-center justify-between mb-3 sm:mb-4">
            ...
            <span class="text-2xl sm:text-3xl font-bold text-ambre-warning"><?php echo e($pendingBookings); ?></span>
        </div>
    ...
    <!-- Stat Card : Acceptées -->
    <a href="<?php echo e(route('client.booking-requests', ['status' => 'accepted'])); ?>"
        ...
        <div class="flex items-center justify-between mb-3 sm:mb-4">
            ...
            <span class="text-2xl sm:text-3xl font-bold text-vert-succes"><?php echo e($acceptedBookings); ?></span>
        </div>
    ...
    <!-- Stat Card : Terminées -->
    <a href="<?php echo e(route('client.booking-requests', ['status' => 'completed'])); ?>"
        ...
        <div class="flex items-center justify-between mb-3 sm:mb-4">
            ...
            <span class="text-2xl sm:text-3xl font-bold text-beige-peau"><?php echo e($completedBookings); ?></span>
        </div>
    ...
    <!-- Stat Card : Refusées -->
    <a href="<?php echo e(route('client.booking-requests', ['status' => 'rejected'])); ?>"
        ...
        <div class="flex items-center justify-between mb-3 sm:mb-4">
            ...
            <span class="text-2xl sm:text-3xl font-bold text-rouge-alerte"><?php echo e($rejectedBookings ?? 0); ?></span>
        </div>
    ...
    <!-- Stat Card : Annulées -->
    <a href="<?php echo e(route('client.booking-requests', ['status' => 'cancelled'])); ?>"
        ...
        <div class="flex items-center justify-between mb-3 sm:mb-4">
            ...
            <span class="text-2xl sm:text-3xl font-bold text-orange-500"><?php echo e($cancelledBookings ?? 0); ?></span>
        </div>
...
<!-- Demandes en cours -->
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->client->bookingRequests()->whereIn('status', ['pending', 'accepted'])->count() > 0): ?>
    <div class="bg-beige-peau/10 border border-beige-peau/30 rounded-xl p-4 mb-6">
        <div class="flex items-center gap-2 mb-2">
            ...
            <h3 class="font-bold text-ivoire-text">
                <?php echo e($this->client->bookingRequests()->whereIn('status', ['pending', 'accepted'])->count()); ?> demande(s)
                en cours</h3>
        </div>
        <!-- Liste des demandes actives -->
        <div class="space-y-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->client->bookingRequests()->whereIn('status', ['pending', 'accepted'])->take(3)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookingRequest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-center gap-2 text-sm text-ivoire-text/70 mb-1">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bookingRequest->estimated_price): ?>
                                    <span>• 💰
                                        <?php echo e(number_format($bookingRequest->estimated_price, 0, ',', ' ')); ?>€</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <div class="flex items-center gap-2 text-sm text-ivoire-text/70 mb-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bookingRequest->bookable): ?>
                                    ...
                                    <span>
                                        <span class="font-medium"><?php echo e($bookingRequest->bookable->user->pseudo); ?></span>
                                        <span class="text-ivoire-text/60">•
                                            <?php echo e($bookingRequest->bookable_type_label); ?></span>
                                    </span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <div class="flex items-center gap-2">
                                    <span class="inline-flex items-center gap-1">
                                        <span
                                            class="inline-flex items-center gap-1 px-2 py-1 rounded-full <?php echo e($bookingRequest->status->color()); ?>20 text-white text-xs font-medium">
                            ...
                            <div class="flex items-center gap-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bookingRequest->status === \App\Enums\BookingRequestStatus::ACCEPTED): ?>
...
<div class="bg-gris-fonde p-6">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->client->bookingRequests->count() > 0): ?>
        <div class="space-y-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->client->bookingRequests->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('client.booking-request.show', $booking)); ?>"
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h3
                                    ...
                                    <?php echo e($booking->bookable->user->pseudo); ?></h3>
                                <p class="text-sm text-ivoire-text/60"><?php echo e($booking->description); ?></p>
                            </div>
                        </div>
                        <div class="text-right">
                            <span
                                class="px-3 py-1 rounded-full text-xs font-semibold
                            <?php echo e($booking->status === \App\Enums\BookingRequestStatus::PENDING ? 'bg-ambre-warning/20 text-ambre-warning' : ''); ?>

                            <?php echo e($booking->status === \App\Enums\BookingRequestStatus::ACCEPTED ? 'bg-vert-succes/20 text-vert-succes' : ''); ?>

                            <?php echo e($booking->status === \App\Enums\BookingRequestStatus::DEPOSIT_PAID ? 'bg-vert-succes/20 text-vert-succes' : ''); ?>

                            <?php echo e($booking->status === \App\Enums\BookingRequestStatus::DATE_CONFIRMED ? 'bg-vert-succes/20 text-vert-succes' : ''); ?>

                            <?php echo e($booking->status === \App\Enums\BookingRequestStatus::COMPLETED ? 'bg-beige-peau/20 text-beige-peau' : ''); ?>

                            <?php echo e($booking->status === \App\Enums\BookingRequestStatus::CANCELLED ? 'bg-rouge-alerte/20 text-rouge-alerte' : ''); ?>

                            <?php echo e($booking->status === \App\Enums\BookingRequestStatus::NO_SHOW ? 'bg-rouge-alerte/20 text-rouge-alerte' : ''); ?>">
                                <?php echo e($booking->status->label()); ?>

                            </span>
                            <p class="text-xs text-ivoire-text/60 mt-1"><?php echo e($booking->created_at->diffForHumans()); ?>

                            </p>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($booking->status === \App\Enums\BookingRequestStatus::ACCEPTED && $booking->conversation): ?>
                                <div class="mt-2">
                                    <a href="<?php echo e(route('client.chat', $booking->conversation)); ?>"
...
<?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\livewire\client\profile-tabs\demandes.blade.php ENDPATH**/ ?>