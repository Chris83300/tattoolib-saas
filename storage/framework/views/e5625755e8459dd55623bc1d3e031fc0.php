...
$displayStyles = array_filter(
    ...
    fn($s) => $s !== 'Autres' && trim($s) !== '',
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type === 'piercer'): ?>
                ...
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($piercingTypes)): ?>
                    <div class="bg-titane/10 rounded-xl p-6 border border-titane/20">
                        <h3 class="text-lg font-bold text-ivoire-text mb-4">💉 Types de piercing</h3>
                        <div class="flex flex-wrap gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $piercingTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type_p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="px-3 py-1 bg-beige-peau/20 text-beige-peau rounded-full text-sm font-medium">
                                    <?php echo e($type_p); ?>
                        ...
                        <div class="space-y-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $pricingGrid; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between py-2 border-b border-titane/10 last:border-0">
                                    <span class="text-ivoire-text text-sm"><?php echo e($entry['type'] ?? ''); ?></span>
                                    <span class="text-beige-peau font-semibold"><?php echo e(number_format($entry['price'] ?? 0, 0, ',', ' ')); ?> €</span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
        ...
        <h2 class="text-xl font-bold text-ivoire-text mb-4">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->reviews->where('is_visible', true)->count() > 0): ?>
                <span class="text-sm font-normal text-titane">
                    (<?php echo e(number_format($artist->reviews->where('is_visible', true)->avg('rating'), 1)); ?>/5 — <?php echo e($artist->reviews->where('is_visible', true)->count()); ?> avis)
                </span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </h2>
                    ...
                    <div class="flex items-center gap-2">
                        <div class="flex">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= 5; $i++): ?>
                                <span class="<?php echo e($i <= $review->rating ? 'text-ambre-warning' : 'text-titane/30'); ?>">&#9733;</span>
                            <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
