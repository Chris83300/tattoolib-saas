    ...
    <div class="min-h-screen bg-noir-profond">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                ...
                <div class="bg-titane/20 rounded-xl p-6 border border-titane/30 text-center">
                    <div class="text-2xl font-bold text-vert-succes mb-1"><?php echo e($reviews->where('rating', '>=', 4)->count()); ?>

                    </div>
                    <div class="text-ivoire-text/60 text-xs">Avis 4-5 étoiles</div>
                </div>
                <div class="bg-titane/20 rounded-xl p-6 border border-titane/30 text-center">
                    <div class="text-2xl font-bold text-ambre-warning mb-1"><?php echo e($reviews->where('rating', 3)->count()); ?>

                    </div>
                    <div class="text-ivoire-text/60 text-xs">Avis 3 étoiles</div>
                </div>
                <div class="bg-titane/20 rounded-xl p-6 border border-titane/30 text-center">
                    <div class="text-2xl font-bold text-rouge-alerte mb-1"><?php echo e($reviews->where('rating', '<=', 2)->count()); ?>
                            ...
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex items-center gap-3">
                                    <div
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($review->tattooer->user->getFirstMediaUrl('avatar')): ?>
                                            <img src="<?php echo e($review->tattooer->user->getFirstMediaUrl('avatar')); ?>"
                                                alt="<?php echo e($review->tattooer->user->pseudo ?? $review->tattooer->user->first_name . ' ' . $review->tattooer->user->last_name); ?>"
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-ivoire-text">
                                            <?php echo e($review->tattooer->user->pseudo ?? $review->tattooer->user->first_name . ' ' . $review->tattooer->user->last_name); ?>
