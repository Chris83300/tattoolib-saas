<div>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4"
        ...
        <div class="relative bg-gris-fonde rounded-2xl p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border border-titane/20">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bookingRequestId): ?>
                <?php $br = \App\Models\BookingRequest::find($bookingRequestId); ?>
...
[$__name, $__params] = $__split('components.availability-calendar', ['tattooerId' => $br->bookable_id,'mode' => 'multi-max-3','showPeriodSelector' => true]);

$__key = 'calendar-repropose-' . $bookingRequestId;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3894973229-0', $__key);
...
<?php /**PATH C:\laragon\www\tattoolib-saas\resources\views/livewire/tattooer/repropose-dates-modal.blade.php ENDPATH**/ ?>