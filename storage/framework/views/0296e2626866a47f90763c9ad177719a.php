...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-gris-fonde rounded-xl p-6">
        <form method="POST" action="<?php echo e(route('studio.artists.invite')); ?>">
            <?php echo csrf_field(); ?>
            <div class="space-y-4">
                <div>
...
<?php echo $__env->make('layouts.studio', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\studio\invite-artist.blade.php ENDPATH**/ ?>