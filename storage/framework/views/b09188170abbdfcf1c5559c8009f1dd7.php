                ...
                <div class="bg-gris-fonde rounded-xl p-6 border border-titane/20">
                    <div class="flex items-start justify-between">
                            ...
                            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="text-ivoire-text text-sm mt-1">
                                        <?php echo e(\Illuminate\Support\Str::limit($bookingRequest->description ?? 'Non spécifié', 80)); ?>
                                ...
                                <div>
                                    ...
                                    <p class="text-ivoire-text text-sm mt-1">
                                        <?php echo e($bookingRequest->body_zone ?? 'Non spécifiée'); ?>
                        ...
                        <div class="flex flex-col gap-2 ml-4">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bookingRequest->status === \App\Enums\BookingRequestStatus::ACCEPTED && $bookingRequest->conversation): ?>
