          ...
          <div class="bg-gris-fonde rounded-xl p-6 border border-titane/20">
            <div class="flex items-start justify-between">
              <div class="flex-1">
                <div class="flex items-center gap-3 mb-3">
                  ...
                  <div class="w-12 h-12 bg-beige-peau/20 rounded-full flex items-center justify-center">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bookingRequest->bookable && $bookingRequest->bookable->getFirstMediaUrl('avatar')): ?>
                    ...
                    <?php else: ?>
                      <span class="text-beige-peau font-bold text-lg">
                        <?php echo e(substr($bookingRequest->bookable->user->name ?? 'Artiste', 0, 2)); ?>
                  ...
                  <div>
                    <h3 class="text-ivoire-text font-semibold">
                      <?php echo e($bookingRequest->bookable->user->name ?? 'Artiste non assigné'); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                  <div>
                    ...
                    <p class="text-ivoire-text font-medium"><?php echo e($bookingRequest->created_at->format('d/m/Y')); ?></p>
                  </div>
                  <div>
                    <span class="text-ivoire-text/50 text-xs">RDV</span>
                    <p class="text-ivoire-text font-medium">
                      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bookingRequest->appointment): ?>
                  ...
                  <div>
                    ...
                    <span class="inline-block px-2 py-1 text-xs rounded-full
                      <?php echo e($bookingRequest->status === 'pending' ? 'bg-ambre-warning/20 text-ambre-warning' : ''); ?>

                      <?php echo e($bookingRequest->status === 'accepted' ? 'bg-vert-succes/20 text-vert-succes' : ''); ?>

                      <?php echo e($bookingRequest->status === 'in_progress' ? 'bg-beige-peau/20 text-beige-peau' : ''); ?>

                      <?php echo e($bookingRequest->status === 'completed' ? 'bg-vert-succes/20 text-vert-succes' : ''); ?>

                      <?php echo e($bookingRequest->status === 'cancelled' ? 'bg-rouge-alerte/20 text-rouge-alerte' : ''); ?>">
              ...
              <div class="flex flex-col gap-2 ml-4">
                <a href="<?php echo e(route('client.booking-requests.show', $bookingRequest)); ?>"
