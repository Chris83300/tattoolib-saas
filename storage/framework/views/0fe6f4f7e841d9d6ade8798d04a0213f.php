    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route($tattooer->routePrefix() . '.clients')); ?>" class="text-ivoire-text/70 hover:text-beige-peau transition-colors">
                    ← Retour aux clients
                </a>
                    ...
                    <div class="flex items-start justify-between">
                        ...
                        <div class="flex items-center gap-2 ml-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($request->conversation): ?>
                                <a href="<?php echo e(route($tattooer->routePrefix() . '.message.show', $request)); ?>"
