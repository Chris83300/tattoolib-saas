            ...
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm text-titane leading-relaxed">
                        ...
                        <a href="<?php echo e(route('legal.politique-cookies')); ?>" class="text-beige-peau hover:underline">
                            En savoir plus
                        </a>
                    </p>
                </div>
...
<?php /**PATH C:\laragon\www\tattoolib-saas\resources\views/partials/cookie-consent.blade.php ENDPATH**/ ?>