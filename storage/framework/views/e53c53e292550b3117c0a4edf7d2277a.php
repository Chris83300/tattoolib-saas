            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                <div class="pt-4 mt-4 border-t border-titane/20 space-y-1">
                    ...
                    <a href="<?php echo e(route('studio.profile')); ?>"
                        class="flex items-center gap-3 px-4 py-3 rounded-lg <?php echo e(request()->routeIs('studio.profile*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond'); ?> transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="bg-beige-peau/10 border-b border-beige-peau/20 px-4 py-2">
                    <div class="flex items-center justify-between">
                        <p class="text-xs text-beige-peau">
                            ⏳ <strong>Essai gratuit</strong> — <?php echo e($studio->trialDaysLeft()); ?> jour<?php echo e($studio->trialDaysLeft() > 1 ? 's' : ''); ?> restant<?php echo e($studio->trialDaysLeft() > 1 ? 's' : ''); ?>

                        </p>
                        <a href="<?php echo e(route('studio.billing')); ?>" class="text-xs font-semibold text-beige-peau hover:text-beige-peau/80">
