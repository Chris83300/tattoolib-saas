        ...
        <aside
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                <a href="<?php echo e(route('studio.conversations')); ?>"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg <?php echo e(request()->routeIs('studio.conversations*') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond'); ?> transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('studio.comptabilite')); ?>"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg <?php echo e(request()->routeIs('studio.comptabilite') ? 'bg-beige-peau text-noir-profond' : 'text-ivoire-text hover:bg-noir-profond'); ?> transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.bottom-nav','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3003794209-0', $__key);
