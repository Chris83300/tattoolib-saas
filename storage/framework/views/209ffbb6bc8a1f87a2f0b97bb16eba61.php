    ...
    <div class="container-custom px-4">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-gris-fonde rounded-xl p-8 mb-8 text-center">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->studio?->is_verified): ?>
                    <div class="mb-6">
                    ...
                    <p class="text-ivoire-text">
                        Votre studio est certifié conforme aux normes ARS et d'hygiène.
                    </p>
                <?php else: ?>
                    <div class="mb-6">
                ...
                <div class="bg-gris-fonde rounded-xl p-6">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('studio.profile')); ?>" class="text-beige-peau hover:underline">
            ...
            <div class="text-center mt-8">
                <a href="<?php echo e(route('studio.profile')); ?>" class="inline-block px-8 py-3 bg-beige-peau text-noir-profond font-bold rounded-lg hover:bg-beige-peau/90 transition-colors">
            ...
            <div class="mt-16">
                ...
                <div class="grid md:grid-cols-3 gap-6">
                    <div class="text-center">
                        ...
                        <p class="text-ivoire-text/60 text-sm">
                            Les clients font confiance aux studios certifiés
                        </p>
                    </div>
                    <div class="text-center">
                        <div class="w-16 h-16 mx-auto mb-4 bg-beige-peau/10 rounded-full flex items-center justify-center">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tattoolib-saas\resources\views\studio\compliance.blade.php ENDPATH**/ ?>