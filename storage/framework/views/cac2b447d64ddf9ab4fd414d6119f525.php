    ...
    <div class="min-h-screen bg-noir-profond flex items-center justify-center px-4 py-12">
        <div class="max-w-2xl w-full">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                ...
                <!-- CLIENT -->
                <button onclick="window.location.href='<?php echo e(route('register.client')); ?>'"
                ...
                <!-- TATTOOER -->
                <button onclick="window.location.href='<?php echo e(route('register.plan', ['type' => 'tattooer'])); ?>'"
                    class="bg-gris-fonde hover:bg-beige-peau/10 hover:border-beige-peau hover:shadow-lg hover:shadow-beige-peau/20 border-2 border-titane/20 shadow-md shadow-titane/10 rounded-xl p-6 text-center transition-all group">
                    <div class="w-16 h-16 mx-auto mb-4 bg-beige-peau/10 rounded-full flex items-center justify-center">
                        <svg class="w-8 h-8 text-beige-peau" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Piercer -->
                <button onclick="window.location.href='<?php echo e(route('register.plan', ['type' => 'piercer'])); ?>'"
                    class="bg-gris-fonde hover:bg-beige-peau/10 hover:border-beige-peau hover:shadow-lg hover:shadow-beige-peau/20 border-2 border-titane/20 shadow-md shadow-titane/10 rounded-xl p-6 text-center transition-all group">
                    <div class="w-16 h-16 mx-auto mb-4 bg-beige-peau/10 rounded-full flex items-center justify-center">
                        <svg class="w-8 h-8 text-beige-peau" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-ivoire-text/70 text-sm">
                        Je suis Piercer / bodemodeur professionnel
                    </p>
                </button>

                <!-- STUDIO -->
                <button onclick="window.location.href='<?php echo e(route('register.studio')); ?>'"
                    class="bg-gris-fonde hover:bg-beige-peau/10 hover:border-beige-peau hover:shadow-lg hover:shadow-beige-peau/20 border-2 border-titane/20 shadow-md shadow-titane/10 rounded-xl p-6 text-center transition-all group">
                    <div class="w-16 h-16 mx-auto mb-4 bg-beige-peau/10 rounded-full flex items-center justify-center">
                        <svg class="w-8 h-8 text-beige-peau" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'submit','variant' => 'secondary','size' => 'sm','href' => ''.e(route('login')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','variant' => 'secondary','size' => 'sm','href' => ''.e(route('login')).'']); ?>
                        Se connecter
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tattoolib-saas\resources\views/auth/register.blade.php ENDPATH**/ ?>