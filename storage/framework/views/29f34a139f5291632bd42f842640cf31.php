                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                ...
                                <?php elseif($testAvatar): ?>
                                    <!-- Prévisualisation du fichier sélectionné -->
                                    <img src="<?php echo e($testAvatar->temporaryUrl()); ?>" alt="Avatar preview"
                                        class="w-full h-full object-cover">
                                <?php else: ?>
                    ...
                    <div>
                        ...
                        <input type="text" wire:model.live="pseudo"
                            value="<?php echo e(auth()->user()->pseudo ?? auth()->user()->first_name . ' ' . auth()->user()->last_name); ?>"
                        ...
                        <p class="text-ivoire-text/50 text-xs mt-1">
                            <?php echo e(30 - strlen($this->pseudo ?? (auth()->user()->pseudo ?? auth()->user()->first_name . ' ' . auth()->user()->last_name))); ?>
