    ...
    <div class="container mx-auto max-w-4xl">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2 flex-wrap">
                            ...
                            <span class="bg-beige-peau/20 text-beige-peau px-3 py-1 rounded-full text-xs font-semibold">
                                <?php echo e($tattooer->subscription_plan === 'pro' ? '⭐ Plan PRO' : '🆓 Plan FREE'); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <!-- Upgrade PRO (si FREE) -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tattooer->subscription_plan !== 'pro'): ?>
                    <div
