        ...
        <div class="bg-gris-fonde border border-titane/20 shadow-md shadow-titane/20 rounded-xl p-6 mb-8">
            <div class="flex flex-col md:flex-row md:items-center gap-6">
                ...
                <div class="flex gap-3 items-center justify-center">
                    ...
                    <a href="<?php echo e(route($tattooer->routePrefix() . '.settings')); ?>" class="text-black btn-shadow rounded-full px-2.5 py-1 font-semibold bg-beige-peau hover:bg-beige-peau/80 transition-colors duration-300 shadow-md shadow-beige-peau/20">
                        Modifier
                    </a>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tattooer->slug): ?>
                        <a href="<?php echo e(route('marketplace.tattooer.show', $tattooer->slug)); ?>" class="text-ivoire-text btn-shadow rounded-full px-2.5 py-1 font-semibold bg-titane/10 hover:bg-titane/20 transition-colors duration-300 shadow-md shadow-titane/20" target="_blank">
                            Voir profil public
                        </a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
